...
Public Sub Initialize(sumFaktor,sumPardakht,VaziatPardakht,SumKhales,SumTakhfifKala,SumTahkfifVizhe,SumKolTakhfif,Tozihat,SignatureBitmapString As String)
	...
	'imgSign=Sign
'	If File.Exists(File.DirInternal & "/Parsik/Signature",MCode.C_Tafzili & ".png") Then
'		imgSign.Bitmap=LoadBitmap(File.DirInternal & "/Parsik/Signature",MCode.C_Tafzili & ".png")
'	End If
