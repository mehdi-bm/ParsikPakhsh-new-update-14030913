...
Public Sub Initialize(CodeMoshtari As String,NameMoshtari As String,CodeVisitor As String,NameVisitor As String,NameCo As String ,ShomareFactor As String,DateFactor As String,DateReport As String,TimeReport As String,Tell As String,Address As String)
	p.Initialize("")
	p.SetLayout(0,0,100%x,100%y)
	p.LoadLayout("L_Faktor1")
