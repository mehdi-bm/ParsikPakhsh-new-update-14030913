B4A=true
Group=Class\Report\PrintFactorType1
...
Sub Class_Globals
	...
	Private lblVaziatPardakht As Label
	Private lblSignS As Label
	Private lblSumKhales As Label
	Private lblSumTakhfifKala As Label
	Private lblSumTahkfifVizhe As Label
...
Public Sub Initialize(sumFaktor,sumPardakht,VaziatPardakht,SumKhales,SumTakhfifKala,SumTahkfifVizhe,SumKolTakhfif,Tozihat,SignatureBitmapString,DarsadArzeshAfzode,ArzeshAfzode,sumMandeAzGhabl As String)
	p.Initialize("")
	p.SetLayout(0,0,100%x,100%y)
	p.LoadLayout("l_faktor3_type1")
	lblSumFaktor.Text=sumFaktor
	lblSumPardakht.Text=sumPardakht
	lblVaziatPardakht.Text=VaziatPardakht
	lblSumKhales.Text=SumKhales
	lblSumTakhfifKala.Text=SumTakhfifKala
	lblSumTahkfifVizhe.Text=SumTahkfifVizhe
	lblSumKolTakhfif.Text=SumKolTakhfif
	lblDarsadArzeshAfzode.Text=DarsadArzeshAfzode
	lblArzeshAfzode.Text=ArzeshAfzode
	lblTozihat.Text=Tozihat
	lblMandeGhabl.Text=sumMandeAzGhabl
	'imgSign=Sign
