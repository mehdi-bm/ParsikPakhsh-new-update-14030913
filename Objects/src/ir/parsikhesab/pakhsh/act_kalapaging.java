...
public class act_kalapaging extends Activity implements B4AActivity{
	public static act_kalapaging mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "ir.parsikhesab.pakhsh", "ir.parsikhesab.pakhsh.act_kalapaging");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (act_kalapaging).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "ir.parsikhesab.pakhsh", "ir.parsikhesab.pakhsh.act_kalapaging");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "ir.parsikhesab.pakhsh.act_kalapaging", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (act_kalapaging) Create " + (isFirst ? "(first time)" : "") + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (act_kalapaging) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (act_kalapaging) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (act_kalapaging) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
RDebugUtils.currentModule="act_kalapaging";
...
RDebugUtils.currentLine=40042497;
 //BA.debugLineNum = 40042497;BA.debugLine="Try";
try {RDebugUtils.currentLine=40042498;
 //BA.debugLineNum = 40042498;BA.debugLine="Activity.LoadLayout(\"L_KalaPaging_2\")";
mostCurrent._activity.LoadLayout("L_KalaPaging_2",mostCurrent.activityBA);
RDebugUtils.currentLine=40042499;
 //BA.debugLineNum = 40042499;BA.debugLine="Hlv.Initializer(\"hlv\").ListView.Horizontal.Build";
mostCurrent._hlv.Initializer(mostCurrent.activityBA,"hlv").ListView().Horizontal().Build();
RDebugUtils.currentLine=40042501;
 //BA.debugLineNum = 40042501;BA.debugLine="pnl_hlv.AddView(Hlv,0,0,96%x ,pnl_hlv.Height)";
...
RDebugUtils.currentLine=40042502;
 //BA.debugLineNum = 40042502;BA.debugLine="Hlv.Show";
mostCurrent._hlv.Show();
 } 
       catch (Exception e7) {
			processBA.setLastException(e7);RDebugUtils.currentLine=40042504;
 //BA.debugLineNum = 40042504;BA.debugLine="Log(LastException)";
anywheresoftware.b4a.keywords.Common.LogImpl("540042504",BA.ObjectToString(anywheresoftware.b4a.keywords.Common.LastException(mostCurrent.activityBA)),0);
RDebugUtils.currentLine=40042505;
 //BA.debugLineNum = 40042505;BA.debugLine="myCode.SendError(LastException,Activity.Title&\"-";
...
RDebugUtils.currentLine=40828928;
 //BA.debugLineNum = 40828928;BA.debugLine="Sub Application_Error (Error As Exception, StackTr";
RDebugUtils.currentLine=40828930;
 //BA.debugLineNum = 40828930;BA.debugLine="Return True";
...
RDebugUtils.currentLine=40501248;
 //BA.debugLineNum = 40501248;BA.debugLine="Private Sub btn_back_Click";
RDebugUtils.currentLine=40501249;
 //BA.debugLineNum = 40501249;BA.debugLine="Activity.Finish";
...
RDebugUtils.currentLine=40632320;
 //BA.debugLineNum = 40632320;BA.debugLine="Private Sub btnNext_Click";
RDebugUtils.currentLine=40632321;
 //BA.debugLineNum = 40632321;BA.debugLine="If pos<listKala.Size Then pos=pos+1";
if (_pos<_listkala.getSize()) { 
_pos = (int) (_pos+1);};
RDebugUtils.currentLine=40632322;
 //BA.debugLineNum = 40632322;BA.debugLine="Hlv.SmoothScrollToPosition(pos)";
...
RDebugUtils.currentLine=40566784;
 //BA.debugLineNum = 40566784;BA.debugLine="Private Sub btnPrev_Click";
RDebugUtils.currentLine=40566785;
 //BA.debugLineNum = 40566785;BA.debugLine="If pos>0 Then pos=pos-1";
if (_pos>0) { 
_pos = (int) (_pos-1);};
RDebugUtils.currentLine=40566786;
 //BA.debugLineNum = 40566786;BA.debugLine="Hlv.SmoothScrollToPosition(pos)";
mostCurrent._hlv.SmoothScrollToPosition(_pos);
...
RDebugUtils.currentLine=40697856;
 //BA.debugLineNum = 40697856;BA.debugLine="Private Sub EventName_onScrollStateChanged (State";
RDebugUtils.currentLine=40697857;
 //BA.debugLineNum = 40697857;BA.debugLine="Select (State)";
...
RDebugUtils.currentLine=40697859;
 //BA.debugLineNum = 40697859;BA.debugLine="Log(\"DRAGGING\")";
anywheresoftware.b4a.keywords.Common.LogImpl("540697859","DRAGGING",0);
 break; }
case 1: {
RDebugUtils.currentLine=40697861;
 //BA.debugLineNum = 40697861;BA.debugLine="Log(\"IDLE\")";
anywheresoftware.b4a.keywords.Common.LogImpl("540697861","IDLE",0);
 break; }
case 2: {
RDebugUtils.currentLine=40697863;
 //BA.debugLineNum = 40697863;BA.debugLine="Log(\"SETTLING\")";
anywheresoftware.b4a.keywords.Common.LogImpl("540697863","SETTLING",0);
 break; }
}
;
...
RDebugUtils.currentLine=40435712;
 //BA.debugLineNum = 40435712;BA.debugLine="Sub hlv_GetItemCount As Int 								        '💯 It";
RDebugUtils.currentLine=40435713;
 //BA.debugLineNum = 40435713;BA.debugLine="Return listKala.Size '/ItemList.Size";
...
ir.parsikhesab.pakhsh.cls_kalapaging _rec = null;
RDebugUtils.currentLine=40370176;
 //BA.debugLineNum = 40370176;BA.debugLine="Sub hlv_onBindViewHolder (Parent As Panel, Positio";
RDebugUtils.currentLine=40370177;
 //BA.debugLineNum = 40370177;BA.debugLine="Dim rec As cls_KalaPaging = Parent.Tag";
_rec = (ir.parsikhesab.pakhsh.cls_kalapaging)(_parent.getTag());
RDebugUtils.currentLine=40370178;
 //BA.debugLineNum = 40370178;BA.debugLine="rec.show(listKala.Get(Position))";
...
RDebugUtils.currentLine=40370179;
 //BA.debugLineNum = 40370179;BA.debugLine="Parent.Width=rec.Width";
_parent.setWidth(_rec._getwidth /*int*/ (null));
RDebugUtils.currentLine=40370180;
 //BA.debugLineNum = 40370180;BA.debugLine="Parent.Height=rec.Height";
...
RDebugUtils.currentLine=40304640;
 //BA.debugLineNum = 40304640;BA.debugLine="Private Sub hlv_onCreateViewHolder (Parent As Pane";
RDebugUtils.currentLine=40304641;
 //BA.debugLineNum = 40304641;BA.debugLine="Dim rec As cls_KalaPaging";
_rec = new ir.parsikhesab.pakhsh.cls_kalapaging();
RDebugUtils.currentLine=40304642;
 //BA.debugLineNum = 40304642;BA.debugLine="rec.Initialize(Me)";
_rec._initialize /*String*/ (null,mostCurrent.activityBA,act_kalapaging.getObject());
RDebugUtils.currentLine=40304643;
 //BA.debugLineNum = 40304643;BA.debugLine="Parent.AddView(rec.Panel,0,0,100%x,100%y)";
...
RDebugUtils.currentLine=40304644;
 //BA.debugLineNum = 40304644;BA.debugLine="Parent.Tag=rec";
...
RDebugUtils.currentLine=40763392;
 //BA.debugLineNum = 40763392;BA.debugLine="Private Sub Hlv_onScrollListener (dx As Int,dy As";
RDebugUtils.currentLine=40763393;
 //BA.debugLineNum = 40763393;BA.debugLine="pos = Hlv.GetVisibleItemPosition(True,False)";
...
RDebugUtils.currentLine=40239104;
 //BA.debugLineNum = 40239104;BA.debugLine="Sub Panel3_Click";
RDebugUtils.currentLine=40239106;
 //BA.debugLineNum = 40239106;BA.debugLine="StartActivity(Act_Sabad)";
...
RDebugUtils.currentLine=40239107;
 //BA.debugLineNum = 40239107;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
