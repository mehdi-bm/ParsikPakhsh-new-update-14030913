...
views.get("pnl_tools").vw.setHeight((int)((views.get("label1").vw.getTop())+(views.get("label1").vw.getHeight())));
...
views.get("img_tipfee").vw.setLeft((int)((views.get("img_sort").vw.getLeft() + views.get("img_sort").vw.getWidth())+(5d / 100 * width)));
views.get("label5").vw.setLeft((int)((views.get("img_sort").vw.getLeft() + views.get("img_sort").vw.getWidth())+(5d / 100 * width)));
