...
public class cls_recashkhas {
    public static RemoteObject myClass;
	public cls_recashkhas() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recashkhas.class);
...
public static RemoteObject _lblvisit = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblkharid = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _opcol1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.ColorDrawable");
public static RemoteObject _opcol2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.ColorDrawable");
...
public static RemoteObject _lblmande = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmovaghat = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbledit = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbldelete = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsend = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"LblAddress",_ref.getField(false, "_lbladdress"),"LblBlackList",_ref.getField(false, "_lblblacklist"),"LblC_Ashkhas",_ref.getField(false, "_lblc_ashkhas"),"LblDelete",_ref.getField(false, "_lbldelete"),"LblEdit",_ref.getField(false, "_lbledit"),"LblKharid",_ref.getField(false, "_lblkharid"),"LblLastSefaresh",_ref.getField(false, "_lbllastsefaresh"),"LblLastVisit",_ref.getField(false, "_lbllastvisit"),"LblMande",_ref.getField(false, "_lblmande"),"LblMandeEtebar",_ref.getField(false, "_lblmandeetebar"),"LblMovaghat",_ref.getField(false, "_lblmovaghat"),"LblN_Ashkhas",_ref.getField(false, "_lbln_ashkhas"),"LblSend",_ref.getField(false, "_lblsend"),"LblVisit",_ref.getField(false, "_lblvisit"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"OpCol1",_ref.getField(false, "_opcol1"),"OpCol2",_ref.getField(false, "_opcol2"),"p",_ref.getField(false, "_p"),"Panel1",_ref.getField(false, "_panel1"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority"),"shakhs",_ref.getField(false, "_shakhs")};
}
}