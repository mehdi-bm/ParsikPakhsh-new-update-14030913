...
public class service_server implements IRemote{
	public static service_server mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("service_server"), "ir.parsikhesab.pakhsh.service_server");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.service_server");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, service_server.class);
        main_subs_0.initializeProcessGlobals();
		return pcBA;
	}
public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _jobinternet = RemoteObject.declareNull("ir.parsikhesab.pakhsh.httpjob");
public static RemoteObject _tgps = RemoteObject.createImmutable(false);
public static RemoteObject _shomarefactorselect = RemoteObject.createImmutable(0);
public static RemoteObject _sendtype = RemoteObject.createImmutable("");
public static RemoteObject _dt1 = RemoteObject.createImmutable("");
public static RemoteObject _dt2 = RemoteObject.createImmutable("");
