...
public class clskala implements IRemote{
	public static clskala mostCurrent;
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, clskala.class);
    static {
		mostCurrent = new clskala();
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.clskala");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("clskala"), "ir.parsikhesab.pakhsh.clskala");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.clskala"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
