...
public class cls_reckalalisti {
    public static RemoteObject myClass;
	public cls_reckalalisti() {
	}
    public static PCBA staticBA = new PCBA(null, cls_reckalalisti.class);
