...
public class cls_kalapaging {
    public static RemoteObject myClass;
	public cls_kalapaging() {
	}
    public static PCBA staticBA = new PCBA(null, cls_kalapaging.class);
...
public static RemoteObject _options = RemoteObject.declareNull("ir.parsikhesab.pakhsh.b4xlisttemplate");
...
public static RemoteObject _lbl_changeprice = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _maxkolrond = RemoteObject.createImmutable(0L);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"btn_edit_Price",_ref.getField(false, "_btn_edit_price"),"BtnDownEshan",_ref.getField(false, "_btndowneshan"),"BtnDownJoz",_ref.getField(false, "_btndownjoz"),"BtnDownKol",_ref.getField(false, "_btndownkol"),"BtnUpEshan",_ref.getField(false, "_btnupeshan"),"BtnUpJoz",_ref.getField(false, "_btnupjoz"),"BtnUpKol",_ref.getField(false, "_btnupkol"),"DateUtils",_ref.getField(false, "_dateutils"),"Dialog",_ref.getField(false, "_dialog"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"ImageOff",_ref.getField(false, "_imageoff"),"ImageRow",_ref.getField(false, "_imagerow"),"Item",_ref.getField(false, "_item"),"Key",_ref.getField(false, "_key"),"Label4",_ref.getField(false, "_label4"),"Lbl_Bascket",_ref.getField(false, "_lbl_bascket"),"lbl_changePrice",_ref.getField(false, "_lbl_changeprice"),"lbl_title",_ref.getField(false, "_lbl_title"),"LblBasketCount",_ref.getField(false, "_lblbasketcount"),"LblC_Kala",_ref.getField(false, "_lblc_kala"),"LblCountEshantion",_ref.getField(false, "_lblcounteshantion"),"LblFee",_ref.getField(false, "_lblfee"),"LblFeeBadAzTakhfid",_ref.getField(false, "_lblfeebadaztakhfid"),"LblGift",_ref.getField(false, "_lblgift"),"LblMablaghMasrafkonande",_ref.getField(false, "_lblmablaghmasrafkonande"),"LblMojoodiJoz",_ref.getField(false, "_lblmojoodijoz"),"LblMojoodiKol",_ref.getField(false, "_lblmojoodikol"),"LblTedadEshan",_ref.getField(false, "_lbltedadeshan"),"LblTedadJoz",_ref.getField(false, "_lbltedadjoz"),"LblTedadKarton",_ref.getField(false, "_lbltedadkarton"),"LblTedadkol",_ref.getField(false, "_lbltedadkol"),"LblTozihat",_ref.getField(false, "_lbltozihat"),"lblVahedJoz",_ref.getField(false, "_lblvahedjoz"),"lblVahedKol",_ref.getField(false, "_lblvahedkol"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"maxkolRond",_ref.getField(false, "_maxkolrond"),"options",_ref.getField(false, "_options"),"p",_ref.getField(false, "_p"),"Panel1",_ref.getField(false, "_panel1"),"Panel2",_ref.getField(false, "_panel2"),"Panel3",_ref.getField(false, "_panel3"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority"),"XUI",_ref.getField(false, "_xui")};
}
}