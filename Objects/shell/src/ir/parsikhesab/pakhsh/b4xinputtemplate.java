...
public static RemoteObject _xdialog = RemoteObject.declareNull("ir.parsikhesab.pakhsh.b4xdialog");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"BorderColor",_ref.getField(false, "_bordercolor"),"BorderColorInvalid",_ref.getField(false, "_bordercolorinvalid"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"IME",_ref.getField(false, "_ime"),"lblTitle",_ref.getField(false, "_lbltitle"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"mAllowDecimals",_ref.getField(false, "_mallowdecimals"),"mBase",_ref.getField(false, "_mbase"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"Priority",_ref.getField(false, "_priority"),"RegexPattern",_ref.getField(false, "_regexpattern"),"Text",_ref.getField(false, "_text"),"TextField1",_ref.getField(false, "_textfield1"),"xDialog",_ref.getField(false, "_xdialog"),"xui",_ref.getField(false, "_xui")};
}
}