...
public class act_sabad implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_sabad"), "ir.parsikhesab.pakhsh.act_sabad");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_sabad.class);
...
public static RemoteObject _listsabad = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _originalitemlist = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
...
public static RemoteObject _btnsabtsefaresh = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _lblnamemoshtari = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _txtsharhfaktor = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
...
public static RemoteObject _pnlns = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _feetip = RemoteObject.createImmutable("");
public static RemoteObject _sumtakhfifriali = RemoteObject.createImmutable(0L);
...
public static RemoteObject _txtmablaghtakhfifikol = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _lblmablaghtakhfifikol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmojavezsefareshtext = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _chamani = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACCheckBoxWrapper");
...
public static RemoteObject _shomaresefaresh = RemoteObject.createImmutable("");
