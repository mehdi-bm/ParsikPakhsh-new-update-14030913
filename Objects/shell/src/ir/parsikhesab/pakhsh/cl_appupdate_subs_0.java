...
try {
		Debug.PushSubsStack("CanRequestPackageInstalls (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,448);
...
try {
		Debug.PushSubsStack("CheckNonMarketAppsEnabled (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,471);
...
try {
		Debug.PushSubsStack("DownloadApk (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,158);
...
public ResumableSub_DownloadApk(ir.parsikhesab.pakhsh.cl_appupdate parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126091265",BA.ObjectToString("---- AppUpdating.DownloadApk"),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
...
//C
this.state = 9;
parent.__c.runVoidMethod ("LogImpl","9126091269",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("missing apk file full path indication"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_finito" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_snewverapk" /*RemoteObject*/ )));
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126091280",(RemoteObject.concat(RemoteObject.createImmutable("Donload ok? "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.getField(true,"_success" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.getField(false,"File").runVoidMethod ("Copy2",(Object)((_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getinputstream" /*RemoteObject*/ ).getObject())),(Object)((_out.getObject())));
 BA.debugLineNum = 180;BA.debugLine="out.Close";
Debug.JustUpdateDeviceLine();
_out.runVoidMethod ("Close");
 BA.debugLineNum = 181;BA.debugLine="Log($\"Copy2 (saving) ok? TRUE\"$)";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126091287",(RemoteObject.createImmutable("Copy2 (saving) ok? TRUE")),0);
...
//C
this.state = 19;
parent.__c.runVoidMethod ("LogImpl","9126091289",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("new apk version downloaded and ready to install"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126091291",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Error: "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.getField(true,"_errormessage" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
//C
this.state = 27;
parent.__c.runVoidMethod ("LogImpl","9126091293",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("error in httputils2"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_release" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ExtractCL (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,381);
...
try {
		Debug.PushSubsStack("ExtractSZ (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,399);
...
try {
		Debug.PushSubsStack("ExtractVN (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,360);
...
try {
		Debug.PushSubsStack("Finito (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,290);
...
try {
		Debug.PushSubsStack("GetAvailableSpace (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,137);
...
Debug.JustUpdateDeviceLine();
if (true) return __ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_getfreespace" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("getCurVN (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,114);
...
try {
		Debug.PushSubsStack("GetFileUri (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,503);
...
try {
		Debug.PushSubsStack("GetFreeSpace (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,421);
...
try {
		Debug.PushSubsStack("GetNMAppInst (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,435);
...
try {
		Debug.PushSubsStack("getPackageName (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("GetSDKVersion (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,428);
...
try {
		Debug.PushSubsStack("getStatus (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,108);
...
try {
		Debug.PushSubsStack("getWebChangeLog (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("getWebFileSize (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,132);
...
try {
		Debug.PushSubsStack("getWebVN (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,120);
...
try {
		Debug.PushSubsStack("Initialize (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,48);
...
Debug.JustUpdateDeviceLine();
cl_appupdate.__c.runVoidMethod ("LogImpl","9125108245",(RemoteObject.concat(RemoteObject.createImmutable("SDK#: "),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_p.runMethod(true,"getSdkVersion")))),RemoteObject.createImmutable(" - UseFP: "),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_usefileprovider" /*RemoteObject*/ )))),RemoteObject.createImmutable(" - SharedFolder: "),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_sharedfolder" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("InstallApk (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,195);
...
Debug.JustUpdateDeviceLine();
cl_appupdate.__c.runVoidMethod ("LogImpl","9126156801",BA.ObjectToString("---- AppUpdating.InstallApk"),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_sendinstallintent" /*RemoteObject*/ );
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_sverbose" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
cl_appupdate.__c.runVoidMethod ("LogImpl","9126156805",RemoteObject.concat(cl_appupdate.__c.getField(true,"TAB"),RemoteObject.createImmutable("user asked to install new apk")),0);};
 }else {
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_sverbose" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
cl_appupdate.__c.runVoidMethod ("LogImpl","9126156808",RemoteObject.concat(cl_appupdate.__c.getField(true,"TAB"),RemoteObject.createImmutable("no permissions from user to install new apk")),0);};
 };
...
try {
		Debug.PushSubsStack("IsValidCV (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,297);
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_sverbose" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
cl_appupdate.__c.runVoidMethod ("LogImpl","9126418948",(RemoteObject.concat(RemoteObject.createImmutable(""),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((cl_appupdate.__c.getField(true,"TAB")))),RemoteObject.createImmutable("missing package name for current version check"))),0);};
 }else {
...
Debug.JustUpdateDeviceLine();
if (__ref.getField(true,"_sverbose" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
cl_appupdate.__c.runVoidMethod ("LogImpl","9126418953",(RemoteObject.concat(RemoteObject.createImmutable(""),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((cl_appupdate.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Current Version: "),cl_appupdate.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_curver" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);};
 };
...
try {
		Debug.PushSubsStack("IsvalidWV (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,312);
...
public ResumableSub_IsvalidWV(ir.parsikhesab.pakhsh.cl_appupdate parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126484481",RemoteObject.createImmutable("IsValidComplete start"),0);
...
//C
this.state = 9;
parent.__c.runVoidMethod ("LogImpl","9126484485",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("missing info file full path indication"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_download" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_snewvertxt" /*RemoteObject*/ )));
 BA.debugLineNum = 325;BA.debugLine="Log(\"before\")";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126484493",RemoteObject.createImmutable("before"),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126484495",RemoteObject.createImmutable("after"),0);
...
//C
this.state = 20;
parent.__c.runVoidMethod ("LogImpl","9126484497",(RemoteObject.concat(RemoteObject.createImmutable("Webserver's info file content: "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"CRLF")))),RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getstring" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
if (true) break;
...
//if
this.state = 50;
if (parent.__c.runMethod(true,"Not",(Object)(_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getstring" /*RemoteObject*/ ).runMethod(true,"contains",(Object)(RemoteObject.createImmutable("<!DOCTYPE html>"))))).<Boolean>get().booleanValue()) { 
this.state = 23;
}else {
this.state = 43;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_webver" /*RemoteObject*/ ,__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_extractvn" /*RemoteObject*/ ,(Object)(_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getstring" /*RemoteObject*/ ))));
 BA.debugLineNum = 332;BA.debugLine="webclog = ExtractCL(J.GetString)					'optional";
Debug.JustUpdateDeviceLine();
__ref.setField ("_webclog" /*RemoteObject*/ ,__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_extractcl" /*RemoteObject*/ ,(Object)(_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getstring" /*RemoteObject*/ ))));
 BA.debugLineNum = 333;BA.debugLine="webfsize = ExtractSZ(J.GetString)					'optiona";
Debug.JustUpdateDeviceLine();
__ref.setField ("_webfsize" /*RemoteObject*/ ,__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_extractsz" /*RemoteObject*/ ,(Object)(_j.runClassMethod (ir.parsikhesab.pakhsh.httpjob.class, "_getstring" /*RemoteObject*/ ))));
...
//C
this.state = 32;
parent.__c.runVoidMethod ("LogImpl","9126484504",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("wrong row format in info file "))),0);
if (true) break;
...
//C
this.state = 40;
parent.__c.runVoidMethod ("LogImpl","9126484507",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Web version number: "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((__ref.getField(true,"_webver" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
if (true) break;
...
//C
this.state = 49;
parent.__c.runVoidMethod ("LogImpl","9126484511",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("ERROR: website returned an HTML error page"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126484514",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Error: "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.getField(true,"_errormessage" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
//C
this.state = 58;
parent.__c.runVoidMethod ("LogImpl","9126484516",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("error in httputils2"))),0);
if (true) break;
...
try {
		Debug.PushSubsStack("ReadCurVN (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,143);
...
Debug.JustUpdateDeviceLine();
cl_appupdate.__c.runVoidMethod ("LogImpl","9125960193",BA.ObjectToString("---- AppUpdating.ReadCurVN"),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
 BA.debugLineNum = 145;BA.debugLine="IsValidCV											'we don't care about its resu";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_isvalidcv" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ReadWebVN (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,151);
...
public ResumableSub_ReadWebVN(ir.parsikhesab.pakhsh.cl_appupdate parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126025729",BA.ObjectToString("---- AppUpdating.ReadWebVN"),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
 BA.debugLineNum = 153;BA.debugLine="Wait For(IsvalidWV) Complete (OkWebVer As Boolean";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "cl_appupdate", "readwebvn"), __ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_isvalidwv" /*RemoteObject*/ ));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("SendInstallIntent (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,487);
...
Debug.JustUpdateDeviceLine();
_i.runVoidMethod ("Initialize",(Object)(BA.ObjectToString("android.intent.action.INSTALL_PACKAGE")),(Object)(BA.ObjectToString(__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_getfileuri" /*RemoteObject*/ ,(Object)(_apkname)))));
...
try {
		Debug.PushSubsStack("SetAndStartSplashScreen (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,532);
...
try {
		Debug.PushSubsStack("setCredentials (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,96);
...
try {
		Debug.PushSubsStack("SetFileUriAsIntentData (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,520);
...
Debug.JustUpdateDeviceLine();
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setData")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_getfileuri" /*RemoteObject*/ ,(Object)(_filename))})));
...
try {
		Debug.PushSubsStack("setNewVerApk (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("setNewVerTxt (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("setPackageName (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,74);
...
try {
		Debug.PushSubsStack("setVerbose (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("StopSplashScreen (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,547);
...
try {
		Debug.PushSubsStack("TryApkUpdate (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,245);
...
public ResumableSub_TryApkUpdate(ir.parsikhesab.pakhsh.cl_appupdate parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
java.util.LinkedHashMap<String, Object> rsLocals = new java.util.LinkedHashMap<String, Object>();
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126287873",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("-- TryApkUpdate"))),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126287883",(RemoteObject.concat(RemoteObject.createImmutable("Donload ok? "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.getField(true,"_success" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126287891",(RemoteObject.createImmutable("Copy2 (saving) ok? TRUE")),0);
...
//C
this.state = 15;
parent.__c.runVoidMethod ("LogImpl","9126287893",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("new apk version downloaded and ready to install"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126287895",(RemoteObject.createImmutable("Copy2 (saving) ok? FALSE")),0);
...
//C
this.state = 23;
parent.__c.runVoidMethod ("LogImpl","9126287897",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("failed download of new apk version"))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126287901",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Error: "),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_j.getField(true,"_errormessage" /*RemoteObject*/ )))),RemoteObject.createImmutable(""))),0);
...
//C
this.state = 32;
parent.__c.runVoidMethod ("LogImpl","9126287903",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("error in httputils2"))),0);
if (true) break;
...
//C
this.state = 42;
parent.__c.runVoidMethod ("LogImpl","9126287910",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("user asked to install new apk"))),0);
if (true) break;
...
try {
		Debug.PushSubsStack("UpdateApk (cl_appupdate) ","cl_appupdate",106,__ref.getField(false, "ba"),__ref,210);
...
public ResumableSub_UpdateApk(ir.parsikhesab.pakhsh.cl_appupdate parent,RemoteObject __ref,RemoteObject _pstatus) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","9126222337",BA.ObjectToString("---- AppUpdating.UpdateApk"),__ref.getField(true,"_logcolor1" /*RemoteObject*/ ));
...
//C
this.state = 9;
parent.__c.runVoidMethod ("LogImpl","9126222340",RemoteObject.concat(parent.__c.getField(true,"TAB"),RemoteObject.createImmutable("no permissions from user to install new apk")),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "cl_appupdate", "updateapk"), __ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_isvalidwv" /*RemoteObject*/ ));
this.state = 62;
return;
case 62:
//C
...
//if
this.state = 60;
if ((RemoteObject.solveBoolean(".",__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_isvalidcv" /*RemoteObject*/ )) && RemoteObject.solveBoolean(".",_okwebver))) { 
this.state = 14;
}if (true) break;
...
//if
this.state = 30;
if (RemoteObject.solveBoolean(">",RemoteObject.solve(new RemoteObject[] {_fsize,RemoteObject.createImmutable(2)}, "*",0, 2),__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_getfreespace" /*RemoteObject*/ ))) { 
this.state = 23;
}if (true) break;
...
//C
this.state = 29;
parent.__c.runVoidMethod ("LogImpl","9126222350",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("no enough available space to download apk"))),0);
if (true) break;
...
//C
this.state = 39;
parent.__c.runVoidMethod ("LogImpl","9126222355",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("Newer version available. Now I try its downloading"))),0);
if (true) break;
...
//C
this.state = 48;
parent.__c.runVoidMethod ("LogImpl","9126222358",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("missing apk file full path indication"))),0);
if (true) break;
...
//C
this.state = 58;
parent.__c.runVoidMethod ("LogImpl","9126222363",(RemoteObject.concat(RemoteObject.createImmutable(""),parent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((parent.__c.getField(true,"TAB")))),RemoteObject.createImmutable("No newer version available on webserver."))),0);
if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (ir.parsikhesab.pakhsh.cl_appupdate.class, "_tryapkupdate" /*void*/ );
