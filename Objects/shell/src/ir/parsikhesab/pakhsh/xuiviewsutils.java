...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.xuiviewsutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("xuiviewsutils"), "ir.parsikhesab.pakhsh.xuiviewsutils");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.xuiviewsutils"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
