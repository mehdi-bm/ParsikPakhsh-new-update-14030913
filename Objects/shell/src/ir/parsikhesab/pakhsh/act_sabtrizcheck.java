...
public class act_sabtrizcheck implements IRemote{
	public static act_sabtrizcheck mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_sabtrizcheck() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_sabtrizcheck"), "ir.parsikhesab.pakhsh.act_sabtrizcheck");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_sabtrizcheck.class);
        main_subs_0.initializeProcessGlobals();
		return pcBA;
	}
public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _shomaredaryafti = RemoteObject.createImmutable("");
...
public static RemoteObject _summablaghcheck = RemoteObject.createImmutable("");
...
public static RemoteObject _txtshomarecheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _txtshomarehesab = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _txtmablagh = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _pnlnbank = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _btndatesarresid = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _txtshobe = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _txtsharh = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
...
public static RemoteObject _originallstcheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
