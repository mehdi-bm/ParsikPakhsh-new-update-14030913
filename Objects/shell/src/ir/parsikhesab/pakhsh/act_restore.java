...
public class act_restore implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_restore"), "ir.parsikhesab.pakhsh.act_restore");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_restore.class);
...
public static RemoteObject _backuplist = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
