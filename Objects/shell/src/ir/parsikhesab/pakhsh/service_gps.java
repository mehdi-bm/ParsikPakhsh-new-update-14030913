...
public class service_gps implements IRemote{
	public static service_gps mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("service_gps"), "ir.parsikhesab.pakhsh.service_gps");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.service_gps");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, service_gps.class);
...
public static RemoteObject _t_startstopgps = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
...
public static RemoteObject _gettime = RemoteObject.createImmutable("");
