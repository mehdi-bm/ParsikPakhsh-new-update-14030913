...
public class base64encodedecodeimage implements IRemote{
	public static base64encodedecodeimage mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public base64encodedecodeimage() {
		mostCurrent = this;
	}
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, base64encodedecodeimage.class);
    static {
		mostCurrent = new base64encodedecodeimage();
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.base64encodedecodeimage");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("base64encodedecodeimage"), "ir.parsikhesab.pakhsh.base64encodedecodeimage");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.base64encodedecodeimage"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
