...
public class act_kala_listi implements IRemote{
	public static act_kala_listi mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_kala_listi() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_kala_listi"), "ir.parsikhesab.pakhsh.act_kala_listi");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_kala_listi.class);
...
public static ir.parsikhesab.pakhsh.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Act_Choose_Report",Debug.moduleToString(ir.parsikhesab.pakhsh.act_choose_report.class),"Act_Emza",Debug.moduleToString(ir.parsikhesab.pakhsh.act_emza.class),"Act_HavaleTozie",Debug.moduleToString(ir.parsikhesab.pakhsh.act_havaletozie.class),"Act_ImageSlideShow",Debug.moduleToString(ir.parsikhesab.pakhsh.act_imageslideshow.class),"Act_KalaDefault",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kaladefault.class),"Act_KalaPaging",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kalapaging.class),"Act_KalaPaging2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kalapaging2.class),"Act_LocationMoshtarian",Debug.moduleToString(ir.parsikhesab.pakhsh.act_locationmoshtarian.class),"Act_LocationVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_locationvisitor.class),"Act_Main",Debug.moduleToString(ir.parsikhesab.pakhsh.act_main.class),"Act_Mali",Debug.moduleToString(ir.parsikhesab.pakhsh.act_mali.class),"Act_Moshtarian",Debug.moduleToString(ir.parsikhesab.pakhsh.act_moshtarian.class),"Act_NewAshkhas",Debug.moduleToString(ir.parsikhesab.pakhsh.act_newashkhas.class),"Act_Notif",Debug.moduleToString(ir.parsikhesab.pakhsh.act_notif.class),"Act_PrintMali",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printmali.class),"Act_PrintPic",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printpic.class),"Act_PrintPic2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printpic2.class),"Act_Profile",Debug.moduleToString(ir.parsikhesab.pakhsh.act_profile.class),"Act_RepFactors",Debug.moduleToString(ir.parsikhesab.pakhsh.act_repfactors.class),"Act_RepFactorVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_repfactorvisitor.class),"Act_ReportRizeBargasht",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportrizebargasht.class),"Act_ReportSoorathesab",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportsoorathesab.class),"Act_ReportVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportvisitor.class),"Act_ReportVisitor2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportvisitor2.class),"Act_RepRizFactorVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reprizfactorvisitor.class),"Act_Restore",Debug.moduleToString(ir.parsikhesab.pakhsh.act_restore.class),"Act_RizeFactorHavale",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizefactorhavale.class),"Act_RizFaktor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizfaktor.class),"Act_RizHavale",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizhavale.class),"Act_Sabad",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabad.class),"Act_SabtMarjooii",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabtmarjooii.class),"Act_SabtRizCheck",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabtrizcheck.class),"Act_SaveInfoCompany",Debug.moduleToString(ir.parsikhesab.pakhsh.act_saveinfocompany.class),"Act_SaveLocation",Debug.moduleToString(ir.parsikhesab.pakhsh.act_savelocation.class),"Act_Search",Debug.moduleToString(ir.parsikhesab.pakhsh.act_search.class),"Act_SelectMantage",Debug.moduleToString(ir.parsikhesab.pakhsh.act_selectmantage.class),"Act_SelFaktor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_selfaktor.class),"Act_SendData",Debug.moduleToString(ir.parsikhesab.pakhsh.act_senddata.class),"Act_Setting",Debug.moduleToString(ir.parsikhesab.pakhsh.act_setting.class),"Act_SettingPos",Debug.moduleToString(ir.parsikhesab.pakhsh.act_settingpos.class),"Act_ShowLocation",Debug.moduleToString(ir.parsikhesab.pakhsh.act_showlocation.class),"Act_Support",Debug.moduleToString(ir.parsikhesab.pakhsh.act_support.class),"Act_Ticket",Debug.moduleToString(ir.parsikhesab.pakhsh.act_ticket.class),"Act_Video",Debug.moduleToString(ir.parsikhesab.pakhsh.act_video.class),"Activity",act_kala_listi.mostCurrent._activity,"B4XComboBox1",act_kala_listi.mostCurrent._b4xcombobox1,"B4XComboBox2",act_kala_listi.mostCurrent._b4xcombobox2,"Barcode",act_kala_listi.mostCurrent._barcode,"Base64EncodeDecodeImage",Debug.moduleToString(ir.parsikhesab.pakhsh.base64encodedecodeimage.class),"btn_Back",act_kala_listi.mostCurrent._btn_back,"BtnCommentExit",act_kala_listi.mostCurrent._btncommentexit,"BtnCommentOK",act_kala_listi.mostCurrent._btncommentok,"BtnSearch",act_kala_listi.mostCurrent._btnsearch,"BtnShowFilterPnl",act_kala_listi.mostCurrent._btnshowfilterpnl,"ClsKala",Debug.moduleToString(ir.parsikhesab.pakhsh.clskala.class),"CmbBox1",act_kala_listi.mostCurrent._cmbbox1,"DateUtils",act_kala_listi.mostCurrent._dateutils,"DBUtils",Debug.moduleToString(ir.parsikhesab.pakhsh.dbutils.class),"Dialog",act_kala_listi.mostCurrent._dialog,"FeeTip",act_kala_listi.mostCurrent._feetip,"FileProvider",act_kala_listi.mostCurrent._fileprovider,"FirebaseMessaging",Debug.moduleToString(ir.parsikhesab.pakhsh.firebasemessaging.class),"FusedLocationService",Debug.moduleToString(ir.parsikhesab.pakhsh.fusedlocationservice.class),"GeoService",Debug.moduleToString(ir.parsikhesab.pakhsh.geoservice.class),"GpsWiget",Debug.moduleToString(ir.parsikhesab.pakhsh.gpswiget.class),"Granularity",act_kala_listi.mostCurrent._granularity,"GroupCodeSelect1",act_kala_listi.mostCurrent._groupcodeselect1,"GroupCodeSelect2",act_kala_listi.mostCurrent._groupcodeselect2,"GroupNameSelect1",act_kala_listi.mostCurrent._groupnameselect1,"GroupNameSelect2",act_kala_listi.mostCurrent._groupnameselect2,"HLV",act_kala_listi.mostCurrent._hlv,"HttpUtils2Service",Debug.moduleToString(ir.parsikhesab.pakhsh.httputils2service.class),"ImageDownloader",Debug.moduleToString(ir.parsikhesab.pakhsh.imagedownloader.class),"ImageView1",act_kala_listi.mostCurrent._imageview1,"Img_barcode",act_kala_listi.mostCurrent._img_barcode,"Img_Paging",act_kala_listi.mostCurrent._img_paging,"Img_sort",act_kala_listi.mostCurrent._img_sort,"Img_TipFee",act_kala_listi.mostCurrent._img_tipfee,"Key",act_kala_listi.mostCurrent._key,"Label11",act_kala_listi.mostCurrent._label11,"Label4",act_kala_listi.mostCurrent._label4,"Label5",act_kala_listi.mostCurrent._label5,"Label6",act_kala_listi.mostCurrent._label6,"Lbl_Bascket",act_kala_listi.mostCurrent._lbl_bascket,"LblBasket",act_kala_listi.mostCurrent._lblbasket,"LblBasketCount",act_kala_listi.mostCurrent._lblbasketcount,"LblPoint",act_kala_listi.mostCurrent._lblpoint,"ListGoroohKala",act_kala_listi.mostCurrent._listgoroohkala,"ListGroohKala",act_kala_listi.mostCurrent._listgroohkala,"ListKalaSp",act_kala_listi.mostCurrent._listkalasp,"ListKalaTxt",act_kala_listi.mostCurrent._listkalatxt,"ListTasvie",act_kala_listi.mostCurrent._listtasvie,"LocationF",act_kala_listi.mostCurrent._locationf,"LocationRequest",act_kala_listi.mostCurrent._locationrequest,"LocationResult",act_kala_listi.mostCurrent._locationresult,"lstSelectedCodeGroupKala",act_kala_listi.mostCurrent._lstselectedcodegroupkala,"Main",Debug.moduleToString(ir.parsikhesab.pakhsh.main.class),"MCode",Debug.moduleToString(ir.parsikhesab.pakhsh.mcode.class),"MDatabase",Debug.moduleToString(ir.parsikhesab.pakhsh.mdatabase.class),"myCode",Debug.moduleToString(ir.parsikhesab.pakhsh.mycode.class),"MyReceiver",Debug.moduleToString(ir.parsikhesab.pakhsh.myreceiver.class),"newinst2",Debug.moduleToString(ir.parsikhesab.pakhsh.newinst2.class),"NiceSpinner",act_kala_listi.mostCurrent._nicespinner,"NiceSpinner1",act_kala_listi.mostCurrent._nicespinner1,"NumberSearch",act_kala_listi.mostCurrent._numbersearch,"OrginalListKala",act_kala_listi.mostCurrent._orginallistkala,"OriginalListGoroohKala",act_kala_listi.mostCurrent._originallistgoroohkala,"Panel2",act_kala_listi.mostCurrent._panel2,"Panel3",act_kala_listi.mostCurrent._panel3,"PermissionsManager",act_kala_listi.mostCurrent._permissionsmanager,"Pnl_Down",act_kala_listi.mostCurrent._pnl_down,"pnl_HLV",act_kala_listi.mostCurrent._pnl_hlv,"Pnl_Tools",act_kala_listi.mostCurrent._pnl_tools,"Pnl_Top",act_kala_listi.mostCurrent._pnl_top,"pnlFilter",act_kala_listi.mostCurrent._pnlfilter,"Priority",act_kala_listi.mostCurrent._priority,"rp",act_kala_listi._rp,"Service_Gps",Debug.moduleToString(ir.parsikhesab.pakhsh.service_gps.class),"Service_Helper",Debug.moduleToString(ir.parsikhesab.pakhsh.service_helper.class),"Service_Notification",Debug.moduleToString(ir.parsikhesab.pakhsh.service_notification.class),"Service_Server",Debug.moduleToString(ir.parsikhesab.pakhsh.service_server.class),"SignatureCapture",Debug.moduleToString(ir.parsikhesab.pakhsh.signaturecapture.class),"Starter",Debug.moduleToString(ir.parsikhesab.pakhsh.starter.class),"Str_sort",act_kala_listi.mostCurrent._str_sort,"SwGift",act_kala_listi.mostCurrent._swgift,"SwMojoodi",act_kala_listi.mostCurrent._swmojoodi,"SwPic",act_kala_listi.mostCurrent._swpic,"SwTakhfif",act_kala_listi.mostCurrent._swtakhfif,"Tracker",Debug.moduleToString(ir.parsikhesab.pakhsh.tracker.class),"TxtSearch",act_kala_listi.mostCurrent._txtsearch,"Wiget_Service",Debug.moduleToString(ir.parsikhesab.pakhsh.wiget_service.class),"XmlViewEx",Debug.moduleToString(ir.parsikhesab.pakhsh.xmlviewex.class),"XUI",act_kala_listi.mostCurrent._xui,"XUIViewsUtils",Debug.moduleToString(ir.parsikhesab.pakhsh.xuiviewsutils.class)};
}
}