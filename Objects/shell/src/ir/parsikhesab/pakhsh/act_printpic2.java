...
public class act_printpic2 implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_printpic2"), "ir.parsikhesab.pakhsh.act_printpic2");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_printpic2.class);
...
public static RemoteObject _datefactor = RemoteObject.createImmutable("");
public static RemoteObject _typeprint = RemoteObject.createImmutable(0);
public static RemoteObject _printer1 = RemoteObject.declareNull("uk.agraham.bluetoothprinter.escposprinter");
public static RemoteObject _ion = RemoteObject.declareNull("Object");
public static RemoteObject _lblprint = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblsettingbtprinter = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
