...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.dbutils");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("dbutils"), "ir.parsikhesab.pakhsh.dbutils");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.dbutils"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
