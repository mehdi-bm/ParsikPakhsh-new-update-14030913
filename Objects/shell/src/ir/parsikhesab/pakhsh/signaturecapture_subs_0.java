...
try {
		Debug.PushSubsStack("Clear (signaturecapture) ","signaturecapture",100,_ba,signaturecapture.mostCurrent,18);
if (RapidSub.canDelegate("clear")) { return ir.parsikhesab.pakhsh.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","clear", _ba, _sd);}
;
...
try {
		Debug.PushSubsStack("Panel_Touch (signaturecapture) ","signaturecapture",100,_ba,signaturecapture.mostCurrent,7);
if (RapidSub.canDelegate("panel_touch")) { return ir.parsikhesab.pakhsh.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","panel_touch", _ba, _sd, _x, _y, _action);}
;
Debug.locals.put("SD", _sd);
...
try {
		Debug.PushSubsStack("Save (signaturecapture) ","signaturecapture",100,_ba,signaturecapture.mostCurrent,22);
if (RapidSub.canDelegate("save")) { return ir.parsikhesab.pakhsh.signaturecapture.remoteMe.runUserSub(false, "signaturecapture","save", _ba, _sd, _dir, _name);}
...
_sd.getField(false,"Canvas" /*RemoteObject*/ ).runMethod(false,"getBitmap").runVoidMethod ("WriteToStream",(Object)((_out.getObject())),(Object)(BA.numberCast(int.class, 100)),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Bitmap.CompressFormat"),RemoteObject.createImmutable("PNG"))));
