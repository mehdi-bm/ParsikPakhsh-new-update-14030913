...
public class cls_faktor2_type1 {
    public static RemoteObject myClass;
	public cls_faktor2_type1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_faktor2_type1.class);
...
public static RemoteObject _lblfee = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmablagh = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnamekala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lbltedajoze = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltakhfifikala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"lblCodeKala",_ref.getField(false, "_lblcodekala"),"lblFee",_ref.getField(false, "_lblfee"),"lblMablagh",_ref.getField(false, "_lblmablagh"),"lblMablaghKhales",_ref.getField(false, "_lblmablaghkhales"),"lblNameKala",_ref.getField(false, "_lblnamekala"),"lblRadif",_ref.getField(false, "_lblradif"),"lblSharh",_ref.getField(false, "_lblsharh"),"lblTakhfifiKala",_ref.getField(false, "_lbltakhfifikala"),"lblTakhfifVizhe",_ref.getField(false, "_lbltakhfifvizhe"),"lblTedadDarKarton",_ref.getField(false, "_lbltedaddarkarton"),"lblTedadKol",_ref.getField(false, "_lbltedadkol"),"lblTedaJoze",_ref.getField(false, "_lbltedajoze"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}