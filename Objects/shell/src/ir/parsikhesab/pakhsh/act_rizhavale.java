...
public class act_rizhavale implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_rizhavale"), "ir.parsikhesab.pakhsh.act_rizhavale");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_rizhavale.class);
...
public static RemoteObject _item1 = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterephavale");
...
public static RemoteObject _lblcountfactor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _swlocation = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
