...
public class cls_factor2_type2 {
    public static RemoteObject myClass;
	public cls_factor2_type2() {
	}
    public static PCBA staticBA = new PCBA(null, cls_factor2_type2.class);
