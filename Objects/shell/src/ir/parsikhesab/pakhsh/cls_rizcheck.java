...
public class cls_rizcheck {
    public static RemoteObject myClass;
	public cls_rizcheck() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rizcheck.class);
...
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistcheckdaryafti");
public static RemoteObject _lblshomarehesab = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblshomaredaryaft = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnamesahebcheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblshobe = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsharh = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _send = RemoteObject.createImmutable(false);
public static RemoteObject _btndelete = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"btnDelete",_ref.getField(false, "_btndelete"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"item",_ref.getField(false, "_item"),"Key",_ref.getField(false, "_key"),"LblDateCheck",_ref.getField(false, "_lbldatecheck"),"LblDateSabt",_ref.getField(false, "_lbldatesabt"),"LblMablagh",_ref.getField(false, "_lblmablagh"),"LblNameBank",_ref.getField(false, "_lblnamebank"),"LblNameSahebcheck",_ref.getField(false, "_lblnamesahebcheck"),"LblSharh",_ref.getField(false, "_lblsharh"),"LblShobe",_ref.getField(false, "_lblshobe"),"LblShomareCheck",_ref.getField(false, "_lblshomarecheck"),"LblShomareDaryaft",_ref.getField(false, "_lblshomaredaryaft"),"LblShomareHesab",_ref.getField(false, "_lblshomarehesab"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority"),"send",_ref.getField(false, "_send")};
}
}