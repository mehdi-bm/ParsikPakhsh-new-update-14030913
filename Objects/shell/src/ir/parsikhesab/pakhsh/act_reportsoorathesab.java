...
public class act_reportsoorathesab implements IRemote{
	public static act_reportsoorathesab mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_reportsoorathesab() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_reportsoorathesab"), "ir.parsikhesab.pakhsh.act_reportsoorathesab");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_reportsoorathesab.class);
...
public static RemoteObject _pnlgrid = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _titlereport = null;
public static RemoteObject _lblsumbedehkar = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsumbestankar = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsummande = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
