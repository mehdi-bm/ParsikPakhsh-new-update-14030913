...
public class main implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("main"), "ir.parsikhesab.pakhsh.main");
	}
...
public static RemoteObject _t_gif = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
public static RemoteObject _rp = RemoteObject.declareNull("anywheresoftware.b4a.objects.RuntimePermissions");
public static RemoteObject _pm = RemoteObject.declareNull("igolub.permissionmanager.b4a.PermissionsManager");
public static RemoteObject _imggif = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
...
public static RemoteObject _pnllogo = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnltitle = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnlver = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
