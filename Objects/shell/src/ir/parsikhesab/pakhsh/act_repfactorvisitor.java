...
public class act_repfactorvisitor implements IRemote{
	public static act_repfactorvisitor mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_repfactorvisitor() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_repfactorvisitor"), "ir.parsikhesab.pakhsh.act_repfactorvisitor");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_repfactorvisitor.class);
