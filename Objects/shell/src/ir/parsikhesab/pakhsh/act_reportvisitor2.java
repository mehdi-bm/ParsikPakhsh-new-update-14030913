...
public class act_reportvisitor2 implements IRemote{
	public static act_reportvisitor2 mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_reportvisitor2() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_reportvisitor2"), "ir.parsikhesab.pakhsh.act_reportvisitor2");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_reportvisitor2.class);
...
public static RemoteObject _lbltedadfaktor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsumfaktor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblpoorsant = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _img_chart = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
