...
public class cls_submenu1 {
    public static RemoteObject myClass;
	public cls_submenu1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_submenu1.class);
...
public static RemoteObject _mdl = RemoteObject.declareNull("Object");
public static RemoteObject _lbl_login = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblvertion = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _pnl_callsuport = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_exit = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_getdata = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_senddata = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_newsefaresh = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_addnewmoshtari = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnlsendtiket = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_elanat = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_reports = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_backup = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnlchangecompany = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _backinfo = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _lbleditnumber = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"apkupdt",_ref.getField(false, "_apkupdt"),"BackInfo",_ref.getField(false, "_backinfo"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"jobInternet",_ref.getField(false, "_jobinternet"),"lbl_Login",_ref.getField(false, "_lbl_login"),"lblEditNumber",_ref.getField(false, "_lbleditnumber"),"lblVertion",_ref.getField(false, "_lblvertion"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"mdl",_ref.getField(false, "_mdl"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_AddNewMoshtari",_ref.getField(false, "_pnl_addnewmoshtari"),"pnl_Backup",_ref.getField(false, "_pnl_backup"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"pnl_CallSuport",_ref.getField(false, "_pnl_callsuport"),"pnl_Elanat",_ref.getField(false, "_pnl_elanat"),"Pnl_Exit",_ref.getField(false, "_pnl_exit"),"pnl_GetData",_ref.getField(false, "_pnl_getdata"),"pnl_NewSefaresh",_ref.getField(false, "_pnl_newsefaresh"),"pnl_Reports",_ref.getField(false, "_pnl_reports"),"Pnl_SendData",_ref.getField(false, "_pnl_senddata"),"Pnl_Video",_ref.getField(false, "_pnl_video"),"PnlChangeCompany",_ref.getField(false, "_pnlchangecompany"),"pnlSendTiket",_ref.getField(false, "_pnlsendtiket"),"Priority",_ref.getField(false, "_priority"),"VerFlag",_ref.getField(false, "_verflag")};
}
}