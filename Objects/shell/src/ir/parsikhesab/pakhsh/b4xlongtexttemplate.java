...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CustomListView1",_ref.getField(false, "_customlistview1"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"mBase",_ref.getField(false, "_mbase"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"Priority",_ref.getField(false, "_priority"),"Text",_ref.getField(false, "_text"),"xui",_ref.getField(false, "_xui")};
}
}