...
public class act_selectmantage implements IRemote{
	public static act_selectmantage mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_selectmantage() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_selectmantage"), "ir.parsikhesab.pakhsh.act_selectmantage");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_selectmantage.class);
...
public static RemoteObject _swvisit = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
...
public static RemoteObject _pnlbed = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _hlvgoroohashkhas = RemoteObject.declareNull("wir.hitex.recycler.Hitex_LayoutView");
...
public static RemoteObject _swblacklist = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
public static RemoteObject _swtourtoday = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
public static RemoteObject _btnlocationmoshtarian = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static ir.parsikhesab.pakhsh.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Act_Choose_Report",Debug.moduleToString(ir.parsikhesab.pakhsh.act_choose_report.class),"Act_Emza",Debug.moduleToString(ir.parsikhesab.pakhsh.act_emza.class),"Act_HavaleTozie",Debug.moduleToString(ir.parsikhesab.pakhsh.act_havaletozie.class),"Act_ImageSlideShow",Debug.moduleToString(ir.parsikhesab.pakhsh.act_imageslideshow.class),"Act_Kala_listi",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kala_listi.class),"Act_KalaDefault",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kaladefault.class),"Act_KalaPaging",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kalapaging.class),"Act_KalaPaging2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_kalapaging2.class),"Act_LocationMoshtarian",Debug.moduleToString(ir.parsikhesab.pakhsh.act_locationmoshtarian.class),"Act_LocationVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_locationvisitor.class),"Act_Main",Debug.moduleToString(ir.parsikhesab.pakhsh.act_main.class),"Act_Mali",Debug.moduleToString(ir.parsikhesab.pakhsh.act_mali.class),"Act_Moshtarian",Debug.moduleToString(ir.parsikhesab.pakhsh.act_moshtarian.class),"Act_NewAshkhas",Debug.moduleToString(ir.parsikhesab.pakhsh.act_newashkhas.class),"Act_Notif",Debug.moduleToString(ir.parsikhesab.pakhsh.act_notif.class),"Act_PrintMali",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printmali.class),"Act_PrintPic",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printpic.class),"Act_PrintPic2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_printpic2.class),"Act_Profile",Debug.moduleToString(ir.parsikhesab.pakhsh.act_profile.class),"Act_RepFactors",Debug.moduleToString(ir.parsikhesab.pakhsh.act_repfactors.class),"Act_RepFactorVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_repfactorvisitor.class),"Act_ReportRizeBargasht",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportrizebargasht.class),"Act_ReportSoorathesab",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportsoorathesab.class),"Act_ReportVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportvisitor.class),"Act_ReportVisitor2",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reportvisitor2.class),"Act_RepRizFactorVisitor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_reprizfactorvisitor.class),"Act_Restore",Debug.moduleToString(ir.parsikhesab.pakhsh.act_restore.class),"Act_RizeFactorHavale",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizefactorhavale.class),"Act_RizFaktor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizfaktor.class),"Act_RizHavale",Debug.moduleToString(ir.parsikhesab.pakhsh.act_rizhavale.class),"Act_Sabad",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabad.class),"Act_SabtMarjooii",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabtmarjooii.class),"Act_SabtRizCheck",Debug.moduleToString(ir.parsikhesab.pakhsh.act_sabtrizcheck.class),"Act_SaveInfoCompany",Debug.moduleToString(ir.parsikhesab.pakhsh.act_saveinfocompany.class),"Act_SaveLocation",Debug.moduleToString(ir.parsikhesab.pakhsh.act_savelocation.class),"Act_Search",Debug.moduleToString(ir.parsikhesab.pakhsh.act_search.class),"Act_SelFaktor",Debug.moduleToString(ir.parsikhesab.pakhsh.act_selfaktor.class),"Act_SendData",Debug.moduleToString(ir.parsikhesab.pakhsh.act_senddata.class),"Act_Setting",Debug.moduleToString(ir.parsikhesab.pakhsh.act_setting.class),"Act_SettingPos",Debug.moduleToString(ir.parsikhesab.pakhsh.act_settingpos.class),"Act_ShowLocation",Debug.moduleToString(ir.parsikhesab.pakhsh.act_showlocation.class),"Act_Support",Debug.moduleToString(ir.parsikhesab.pakhsh.act_support.class),"Act_Ticket",Debug.moduleToString(ir.parsikhesab.pakhsh.act_ticket.class),"Act_Video",Debug.moduleToString(ir.parsikhesab.pakhsh.act_video.class),"Activity",act_selectmantage.mostCurrent._activity,"B4XComboBox1",act_selectmantage.mostCurrent._b4xcombobox1,"B4XComboBox2",act_selectmantage.mostCurrent._b4xcombobox2,"Base64EncodeDecodeImage",Debug.moduleToString(ir.parsikhesab.pakhsh.base64encodedecodeimage.class),"btn_sort",act_selectmantage.mostCurrent._btn_sort,"btnLocationMoshtarian",act_selectmantage.mostCurrent._btnlocationmoshtarian,"btnMenuGroup",act_selectmantage.mostCurrent._btnmenugroup,"btnNewAshkhas",act_selectmantage.mostCurrent._btnnewashkhas,"ClsKala",Debug.moduleToString(ir.parsikhesab.pakhsh.clskala.class),"countsefaresh",act_selectmantage._countsefaresh,"countvisit",act_selectmantage._countvisit,"CuAshkhas",act_selectmantage.mostCurrent._cuashkhas,"Date",act_selectmantage.mostCurrent._date,"DateUtils",act_selectmantage.mostCurrent._dateutils,"DBUtils",Debug.moduleToString(ir.parsikhesab.pakhsh.dbutils.class),"FileProvider",act_selectmantage.mostCurrent._fileprovider,"FirebaseMessaging",Debug.moduleToString(ir.parsikhesab.pakhsh.firebasemessaging.class),"FusedLocationService",Debug.moduleToString(ir.parsikhesab.pakhsh.fusedlocationservice.class),"GeoService",Debug.moduleToString(ir.parsikhesab.pakhsh.geoservice.class),"Gps",act_selectmantage._gps,"GpsWiget",Debug.moduleToString(ir.parsikhesab.pakhsh.gpswiget.class),"Granularity",act_selectmantage.mostCurrent._granularity,"GroupCodeSelect1",act_selectmantage.mostCurrent._groupcodeselect1,"GroupCodeSelect2",act_selectmantage.mostCurrent._groupcodeselect2,"GroupNameSelect1",act_selectmantage.mostCurrent._groupnameselect1,"GroupNameSelect2",act_selectmantage.mostCurrent._groupnameselect2,"HLV",act_selectmantage.mostCurrent._hlv,"HLVGoroohAshkhas",act_selectmantage.mostCurrent._hlvgoroohashkhas,"HttpUtils2Service",Debug.moduleToString(ir.parsikhesab.pakhsh.httputils2service.class),"ImageDownloader",Debug.moduleToString(ir.parsikhesab.pakhsh.imagedownloader.class),"Key",act_selectmantage.mostCurrent._key,"lblBackGroup",act_selectmantage.mostCurrent._lblbackgroup,"lblTedadKol",act_selectmantage.mostCurrent._lbltedadkol,"LblTedadSefaresh",act_selectmantage.mostCurrent._lbltedadsefaresh,"LblTedadVisit",act_selectmantage.mostCurrent._lbltedadvisit,"ListAshkhas",act_selectmantage.mostCurrent._listashkhas,"ListGoroohAshkhas1",act_selectmantage.mostCurrent._listgoroohashkhas1,"ListGoroohAshkhas2",act_selectmantage.mostCurrent._listgoroohashkhas2,"ListMantaghe",act_selectmantage.mostCurrent._listmantaghe,"LocationF",act_selectmantage.mostCurrent._locationf,"LocationRequest",act_selectmantage.mostCurrent._locationrequest,"LocationResult",act_selectmantage.mostCurrent._locationresult,"lstGroup1",act_selectmantage.mostCurrent._lstgroup1,"lstGroup2",act_selectmantage.mostCurrent._lstgroup2,"lstSelectedCodeGroupAshkhas",act_selectmantage.mostCurrent._lstselectedcodegroupashkhas,"Main",Debug.moduleToString(ir.parsikhesab.pakhsh.main.class),"MCode",Debug.moduleToString(ir.parsikhesab.pakhsh.mcode.class),"MDatabase",Debug.moduleToString(ir.parsikhesab.pakhsh.mdatabase.class),"myCode",Debug.moduleToString(ir.parsikhesab.pakhsh.mycode.class),"MyReceiver",Debug.moduleToString(ir.parsikhesab.pakhsh.myreceiver.class),"newinst2",Debug.moduleToString(ir.parsikhesab.pakhsh.newinst2.class),"NiceSpinner",act_selectmantage.mostCurrent._nicespinner,"NiceSpinner1",act_selectmantage.mostCurrent._nicespinner1,"OrginalListAshkhas",act_selectmantage.mostCurrent._orginallistashkhas,"OriginalListGoroohAshkhas1",act_selectmantage.mostCurrent._originallistgoroohashkhas1,"OriginalListGoroohAshkhas2",act_selectmantage.mostCurrent._originallistgoroohashkhas2,"PermissionsManager",act_selectmantage.mostCurrent._permissionsmanager,"pnl_HLV",act_selectmantage.mostCurrent._pnl_hlv,"PnlBed",act_selectmantage.mostCurrent._pnlbed,"pnlGroup",act_selectmantage.mostCurrent._pnlgroup,"PnlSpGroup",act_selectmantage.mostCurrent._pnlspgroup,"Priority",act_selectmantage.mostCurrent._priority,"rp",act_selectmantage.mostCurrent._rp,"Service_Gps",Debug.moduleToString(ir.parsikhesab.pakhsh.service_gps.class),"Service_Helper",Debug.moduleToString(ir.parsikhesab.pakhsh.service_helper.class),"Service_Notification",Debug.moduleToString(ir.parsikhesab.pakhsh.service_notification.class),"Service_Server",Debug.moduleToString(ir.parsikhesab.pakhsh.service_server.class),"sidemenu",act_selectmantage.mostCurrent._sidemenu,"SignatureCapture",Debug.moduleToString(ir.parsikhesab.pakhsh.signaturecapture.class),"Starter",Debug.moduleToString(ir.parsikhesab.pakhsh.starter.class),"Str_sort",act_selectmantage.mostCurrent._str_sort,"SwBed",act_selectmantage.mostCurrent._swbed,"SwBes",act_selectmantage.mostCurrent._swbes,"SwBlackList",act_selectmantage.mostCurrent._swblacklist,"SwNew",act_selectmantage.mostCurrent._swnew,"swSearchByAddress",act_selectmantage.mostCurrent._swsearchbyaddress,"SwTourToday",act_selectmantage.mostCurrent._swtourtoday,"SwVisit",act_selectmantage.mostCurrent._swvisit,"t1",act_selectmantage._t1,"tcount",act_selectmantage._tcount,"Tracker",Debug.moduleToString(ir.parsikhesab.pakhsh.tracker.class),"TxtSearch",act_selectmantage.mostCurrent._txtsearch,"UtilS",act_selectmantage.mostCurrent._utils,"Wiget_Service",Debug.moduleToString(ir.parsikhesab.pakhsh.wiget_service.class),"XmlViewEx",Debug.moduleToString(ir.parsikhesab.pakhsh.xmlviewex.class),"XUIViewsUtils",Debug.moduleToString(ir.parsikhesab.pakhsh.xuiviewsutils.class)};
}
}