...
public class asbuttonslider {
    public static RemoteObject myClass;
	public asbuttonslider() {
	}
    public static PCBA staticBA = new PCBA(null, asbuttonslider.class);
...
public static RemoteObject _xpnl_leftside = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _xpnl_rightside = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _xpnl_slidebutton = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _tmp_xpnl_leftside = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
public static RemoteObject _tmp_xpnl_rightside = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XViewWrapper");
...
public static RemoteObject _breachedlefttop = RemoteObject.createImmutable(false);
public static RemoteObject _breachedrightbottom = RemoteObject.createImmutable(false);
public static RemoteObject _xbuttonorientation = RemoteObject.createImmutable("");
public static RemoteObject _xlefttopcolor = RemoteObject.createImmutable(0);
public static RemoteObject _xrightbottomcolor = RemoteObject.createImmutable(0);
public static RemoteObject _xsliderbuttoncolor = RemoteObject.createImmutable(0);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"bReachedLeftTop",_ref.getField(false, "_breachedlefttop"),"bReachedRightBottom",_ref.getField(false, "_breachedrightbottom"),"DateUtils",_ref.getField(false, "_dateutils"),"donwx",_ref.getField(false, "_donwx"),"downy",_ref.getField(false, "_downy"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"mBase",_ref.getField(false, "_mbase"),"mCallBack",_ref.getField(false, "_mcallback"),"mEventName",_ref.getField(false, "_meventname"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"Priority",_ref.getField(false, "_priority"),"tmp_xpnl_leftside",_ref.getField(false, "_tmp_xpnl_leftside"),"tmp_xpnl_rightside",_ref.getField(false, "_tmp_xpnl_rightside"),"xButtonOrientation",_ref.getField(false, "_xbuttonorientation"),"xLeftTopColor",_ref.getField(false, "_xlefttopcolor"),"xpnl_leftside",_ref.getField(false, "_xpnl_leftside"),"xpnl_rightside",_ref.getField(false, "_xpnl_rightside"),"xpnl_slidebutton",_ref.getField(false, "_xpnl_slidebutton"),"xRightBottomColor",_ref.getField(false, "_xrightbottomcolor"),"xSliderButtonColor",_ref.getField(false, "_xsliderbuttoncolor"),"xui",_ref.getField(false, "_xui")};
}
}