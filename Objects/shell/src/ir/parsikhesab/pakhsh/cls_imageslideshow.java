...
public class cls_imageslideshow {
    public static RemoteObject myClass;
	public cls_imageslideshow() {
	}
    public static PCBA staticBA = new PCBA(null, cls_imageslideshow.class);
...
public static RemoteObject _imagerow = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
