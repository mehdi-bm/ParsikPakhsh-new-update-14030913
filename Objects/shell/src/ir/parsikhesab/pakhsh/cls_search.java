...
public class cls_search {
    ...
    public static PCBA staticBA = new PCBA(null, cls_search.class);
...
public static RemoteObject _glide = RemoteObject.declareNull("com.glide.Hitex_Glide");
