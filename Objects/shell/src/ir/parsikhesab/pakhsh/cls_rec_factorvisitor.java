...
public class cls_rec_factorvisitor {
    public static RemoteObject myClass;
	public cls_rec_factorvisitor() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_factorvisitor.class);
...
public static RemoteObject _btnjoziat = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"BtnCheck",_ref.getField(false, "_btncheck"),"btnJoziat",_ref.getField(false, "_btnjoziat"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"lblCodeTafzili",_ref.getField(false, "_lblcodetafzili"),"lblCodeVisitor",_ref.getField(false, "_lblcodevisitor"),"LblDate",_ref.getField(false, "_lbldate"),"lblNameVisitor",_ref.getField(false, "_lblnamevisitor"),"lblSharh",_ref.getField(false, "_lblsharh"),"lblSharhTafzili",_ref.getField(false, "_lblsharhtafzili"),"LblShomareFaktor",_ref.getField(false, "_lblshomarefaktor"),"lblTime",_ref.getField(false, "_lbltime"),"lblVaziatSefaresh",_ref.getField(false, "_lblvaziatsefaresh"),"lblVaziatTasfie",_ref.getField(false, "_lblvaziattasfie"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"Panel4",_ref.getField(false, "_panel4"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}