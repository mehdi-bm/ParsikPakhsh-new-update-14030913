...
public class mycode implements IRemote{
	public static mycode mostCurrent;
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, mycode.class);
    static {
		mostCurrent = new mycode();
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mycode");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("mycode"), "ir.parsikhesab.pakhsh.mycode");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.mycode"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static RemoteObject _b64 = RemoteObject.declareNull("anywheresoftware.b4a.objects.StringUtils");
