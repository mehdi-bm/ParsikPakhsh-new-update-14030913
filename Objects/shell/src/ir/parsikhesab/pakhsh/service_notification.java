...
public class service_notification implements IRemote{
	public static service_notification mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("service_notification"), "ir.parsikhesab.pakhsh.service_notification");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.service_notification");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, service_notification.class);
...
public static RemoteObject _noti = RemoteObject.declareNull("barxdroid.advancednotification.AdvancedNotification");
