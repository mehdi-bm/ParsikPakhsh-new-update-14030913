...
public class act_savelocation implements IRemote{
	public static act_savelocation mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_savelocation() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_savelocation"), "ir.parsikhesab.pakhsh.act_savelocation");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_savelocation.class);
...
public static RemoteObject _location1 = RemoteObject.declareNull("anywheresoftware.b4a.gps.LocationWrapper");
