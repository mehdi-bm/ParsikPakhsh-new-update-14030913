...
public class cls_rec_video {
    public static RemoteObject myClass;
	public cls_rec_video() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_video.class);
...
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistvideo");
