...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"builder",_ref.getField(false, "_builder"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"Priority",_ref.getField(false, "_priority")};
}
}