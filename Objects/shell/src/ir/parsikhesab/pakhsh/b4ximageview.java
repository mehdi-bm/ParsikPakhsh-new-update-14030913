...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"iv",_ref.getField(false, "_iv"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"mBackgroundColor",_ref.getField(false, "_mbackgroundcolor"),"mBase",_ref.getField(false, "_mbase"),"mBitmap",_ref.getField(false, "_mbitmap"),"mCallBack",_ref.getField(false, "_mcallback"),"mCornersRadius",_ref.getField(false, "_mcornersradius"),"mEventName",_ref.getField(false, "_meventname"),"mResizeMode",_ref.getField(false, "_mresizemode"),"mRound",_ref.getField(false, "_mround"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"Priority",_ref.getField(false, "_priority"),"Tag",_ref.getField(false, "_tag"),"xui",_ref.getField(false, "_xui")};
}
}