...
public class cls_printmali {
    public static RemoteObject myClass;
	public cls_printmali() {
	}
    public static PCBA staticBA = new PCBA(null, cls_printmali.class);
...
public static RemoteObject _lbltarikh = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnamemoshtari = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbladress = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltel = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltitle = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _parent = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"Label1",_ref.getField(false, "_label1"),"lblAdress",_ref.getField(false, "_lbladress"),"LblNameMoshtari",_ref.getField(false, "_lblnamemoshtari"),"lblTarikh",_ref.getField(false, "_lbltarikh"),"lblTel",_ref.getField(false, "_lbltel"),"lblTitle",_ref.getField(false, "_lbltitle"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"Parent",_ref.getField(false, "_parent"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}