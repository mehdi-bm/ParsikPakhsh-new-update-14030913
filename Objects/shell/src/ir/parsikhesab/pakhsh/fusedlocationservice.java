...
public class fusedlocationservice implements IRemote{
	public static fusedlocationservice mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("fusedlocationservice"), "ir.parsikhesab.pakhsh.fusedlocationservice");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.fusedlocationservice");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, fusedlocationservice.class);
...
public static RemoteObject _tgps = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
public static RemoteObject _t_startstopgps = RemoteObject.declareNull("anywheresoftware.b4a.objects.Timer");
public static RemoteObject _tracking = RemoteObject.createImmutable(false);
...
public static RemoteObject _nid = RemoteObject.createImmutable(0);
public static RemoteObject _inc = RemoteObject.createImmutable(0L);
