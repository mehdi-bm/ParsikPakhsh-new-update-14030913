...
public class cls_recfaktor {
    public static RemoteObject myClass;
	public cls_recfaktor() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recfaktor.class);
...
public static RemoteObject _lblsync = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblbargasht = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"faktor",_ref.getField(false, "_faktor"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"LblBargasht",_ref.getField(false, "_lblbargasht"),"LblDate",_ref.getField(false, "_lbldate"),"LblShomareFaktor",_ref.getField(false, "_lblshomarefaktor"),"LblSync",_ref.getField(false, "_lblsync"),"LblTotalFaktor",_ref.getField(false, "_lbltotalfaktor"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}