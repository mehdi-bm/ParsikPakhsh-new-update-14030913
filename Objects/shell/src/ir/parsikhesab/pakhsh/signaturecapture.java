...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.signaturecapture");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("signaturecapture"), "ir.parsikhesab.pakhsh.signaturecapture");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.signaturecapture"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
