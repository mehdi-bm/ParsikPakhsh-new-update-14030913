...
public class act_repfactors implements IRemote{
	public static act_repfactors mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_repfactors() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_repfactors"), "ir.parsikhesab.pakhsh.act_repfactors");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_repfactors.class);
...
public static RemoteObject _totalfactor = RemoteObject.createImmutable("");
...
public static RemoteObject _lblnames = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblvaziats = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _cmbvaziat = RemoteObject.declareNull("ir.parsikhesab.pakhsh.b4xcombobox");
