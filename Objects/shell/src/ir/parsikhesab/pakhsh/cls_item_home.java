...
public class cls_item_home {
    public static RemoteObject myClass;
	public cls_item_home() {
	}
    public static PCBA staticBA = new PCBA(null, cls_item_home.class);
