...
public class act_printpic implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_printpic"), "ir.parsikhesab.pakhsh.act_printpic");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_printpic.class);
...
public static RemoteObject _imagesignature = RemoteObject.createImmutable("");
public static RemoteObject _signatureupdate = RemoteObject.createImmutable("");
