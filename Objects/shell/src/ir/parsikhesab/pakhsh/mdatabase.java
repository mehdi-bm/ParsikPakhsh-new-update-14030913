...
public class mdatabase implements IRemote{
	public static mdatabase mostCurrent;
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, mdatabase.class);
    static {
		mostCurrent = new mdatabase();
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mdatabase");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("mdatabase"), "ir.parsikhesab.pakhsh.mdatabase");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.mdatabase"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
