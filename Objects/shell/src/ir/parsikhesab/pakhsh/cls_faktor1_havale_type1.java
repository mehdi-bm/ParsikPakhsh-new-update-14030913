...
public class cls_faktor1_havale_type1 {
    public static RemoteObject myClass;
	public cls_faktor1_havale_type1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_faktor1_havale_type1.class);
...
public static RemoteObject _lbldatereport = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lbltimereport = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"lblAddress",_ref.getField(false, "_lbladdress"),"lblAddressCompany",_ref.getField(false, "_lbladdresscompany"),"lblCodeMoshtari",_ref.getField(false, "_lblcodemoshtari"),"lblCodeVisitor",_ref.getField(false, "_lblcodevisitor"),"lblDateFactor",_ref.getField(false, "_lbldatefactor"),"lblDateReport",_ref.getField(false, "_lbldatereport"),"lblNameCo",_ref.getField(false, "_lblnameco"),"lblNameCompany",_ref.getField(false, "_lblnamecompany"),"lblNameMoshtari",_ref.getField(false, "_lblnamemoshtari"),"lblNameVisitor",_ref.getField(false, "_lblnamevisitor"),"lblShomareFactor",_ref.getField(false, "_lblshomarefactor"),"lblTell",_ref.getField(false, "_lbltell"),"lblTellCompany",_ref.getField(false, "_lbltellcompany"),"lblTimeReport",_ref.getField(false, "_lbltimereport"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}