...
public class cls_faktor3_type1 {
    public static RemoteObject myClass;
	public cls_faktor3_type1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_faktor3_type1.class);
...
public static RemoteObject _lblvaziatpardakht = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblsumtakhfifkala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsumtahkfifvizhe = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"imgSign",_ref.getField(false, "_imgsign"),"lblArzeshAfzode",_ref.getField(false, "_lblarzeshafzode"),"lblDarsadArzeshAfzode",_ref.getField(false, "_lbldarsadarzeshafzode"),"lblMandeGhabl",_ref.getField(false, "_lblmandeghabl"),"lblSignS",_ref.getField(false, "_lblsigns"),"lblSumFaktor",_ref.getField(false, "_lblsumfaktor"),"lblSumKhales",_ref.getField(false, "_lblsumkhales"),"lblSumKolTakhfif",_ref.getField(false, "_lblsumkoltakhfif"),"lblSumPardakht",_ref.getField(false, "_lblsumpardakht"),"lblSumTahkfifVizhe",_ref.getField(false, "_lblsumtahkfifvizhe"),"lblSumTakhfifKala",_ref.getField(false, "_lblsumtakhfifkala"),"lblTozihat",_ref.getField(false, "_lbltozihat"),"lblVaziatPardakht",_ref.getField(false, "_lblvaziatpardakht"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}