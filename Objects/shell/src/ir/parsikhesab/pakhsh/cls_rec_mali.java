...
public class cls_rec_mali {
    public static RemoteObject myClass;
	public cls_rec_mali() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_mali.class);
...
public static RemoteObject _lbldatecheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbldatesabt = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmablagh = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnamebank = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblshomarecheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblshomaresabt = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltypesabt = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnoesabt = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistsabt");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"item",_ref.getField(false, "_item"),"Key",_ref.getField(false, "_key"),"LblDateCheck",_ref.getField(false, "_lbldatecheck"),"LblDateSabt",_ref.getField(false, "_lbldatesabt"),"LblMablagh",_ref.getField(false, "_lblmablagh"),"LblNameBank",_ref.getField(false, "_lblnamebank"),"LblNoeSabt",_ref.getField(false, "_lblnoesabt"),"LblShomareCheck",_ref.getField(false, "_lblshomarecheck"),"LblShomareSabt",_ref.getField(false, "_lblshomaresabt"),"LblTypeSabt",_ref.getField(false, "_lbltypesabt"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}