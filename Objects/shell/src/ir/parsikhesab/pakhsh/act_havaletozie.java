...
public class act_havaletozie implements IRemote{
	public static act_havaletozie mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_havaletozie() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_havaletozie"), "ir.parsikhesab.pakhsh.act_havaletozie");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_havaletozie.class);
...
public static RemoteObject _swopen = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
public static RemoteObject _swclose = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
public static RemoteObject _swtoday = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
public static RemoteObject _txtsearch = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
public static RemoteObject _listhavale = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _originallisthavale = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _orderby = RemoteObject.createImmutable("");
public static RemoteObject _lbltedadtoday = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadclose = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadopen = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
