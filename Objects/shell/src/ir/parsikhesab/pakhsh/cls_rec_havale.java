...
public class cls_rec_havale {
    public static RemoteObject myClass;
	public cls_rec_havale() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_havale.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterephavale");
...
public static RemoteObject _lblcheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbluncheck = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblshowhavale = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"Item",_ref.getField(false, "_item"),"lblCheck",_ref.getField(false, "_lblcheck"),"lblCount",_ref.getField(false, "_lblcount"),"LblDate",_ref.getField(false, "_lbldate"),"LblShomareHavale",_ref.getField(false, "_lblshomarehavale"),"lblShowHavale",_ref.getField(false, "_lblshowhavale"),"LblTotal",_ref.getField(false, "_lbltotal"),"lblUnCheck",_ref.getField(false, "_lbluncheck"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}