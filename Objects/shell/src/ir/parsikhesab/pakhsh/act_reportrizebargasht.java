...
public class act_reportrizebargasht implements IRemote{
	public static act_reportrizebargasht mostCurrent;
	public static RemoteObject processBA;
    public static boolean processGlobalsRun;
    public static RemoteObject myClass;
    public static RemoteObject remoteMe;
	public act_reportrizebargasht() {
		mostCurrent = this;
	}
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_reportrizebargasht"), "ir.parsikhesab.pakhsh.act_reportrizebargasht");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_reportrizebargasht.class);
        main_subs_0.initializeProcessGlobals();
		return pcBA;
	}
public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _shomareforoosh = RemoteObject.createImmutable("");
public static RemoteObject _shomarefaktor = RemoteObject.createImmutable("");
public static RemoteObject _dateaz = RemoteObject.createImmutable("");
public static RemoteObject _dateta = RemoteObject.createImmutable("");
public static RemoteObject _table1 = RemoteObject.declareNull("ir.parsikhesab.pakhsh.table");
public static RemoteObject _table2 = RemoteObject.declareNull("ir.parsikhesab.pakhsh.table");
...
public static RemoteObject _listfaktor1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _listfaktor2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _listfaktor3 = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
public static RemoteObject _lblback = RemoteObject.declareNull("anywheresoftware.b4a.objects.ButtonWrapper");
public static RemoteObject _pnl_table1 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnl_table2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
