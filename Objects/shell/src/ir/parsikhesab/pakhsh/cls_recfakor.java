...
public class cls_recfakor {
    public static RemoteObject myClass;
	public cls_recfakor() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recfakor.class);
...
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistashkhas");
...
public static RemoteObject _lblshfaktor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbl_city = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _chk_send = RemoteObject.declareNull("anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"ChK_send",_ref.getField(false, "_chk_send"),"DateUtils",_ref.getField(false, "_dateutils"),"faktor",_ref.getField(false, "_faktor"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"Item",_ref.getField(false, "_item"),"lbl_city",_ref.getField(false, "_lbl_city"),"LblNameMoshtari",_ref.getField(false, "_lblnamemoshtari"),"LblshFaktor",_ref.getField(false, "_lblshfaktor"),"LblTotalFaktor",_ref.getField(false, "_lbltotalfaktor"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority"),"TxtSharhFaktor",_ref.getField(false, "_txtsharhfaktor")};
}
}