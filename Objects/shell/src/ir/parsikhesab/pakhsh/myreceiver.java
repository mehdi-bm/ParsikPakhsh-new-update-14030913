...
public class myreceiver implements IRemote{
	public static myreceiver mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("myreceiver"), "ir.parsikhesab.pakhsh.myreceiver");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.myreceiver");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, myreceiver.class);
