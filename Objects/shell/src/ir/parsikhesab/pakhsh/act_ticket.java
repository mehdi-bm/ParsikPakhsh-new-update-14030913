...
public class act_ticket implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("act_ticket"), "ir.parsikhesab.pakhsh.act_ticket");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, act_ticket.class);
...
public static RemoteObject _web = RemoteObject.declareNull("anywheresoftware.b4a.objects.WebViewWrapper");
public static RemoteObject _wview = RemoteObject.declareNull("uk.co.martinpearman.b4a.webkit.WebViewExtras");
