...
public class xmlviewex implements IRemote{
	public static xmlviewex mostCurrent;
...
public boolean isSingleton() {
     ...
     private static PCBA pcBA = new PCBA(null, xmlviewex.class);
    static {
		mostCurrent = new xmlviewex();
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.xmlviewex");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("xmlviewex"), "ir.parsikhesab.pakhsh.xmlviewex");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("ir.parsikhesab.pakhsh.xmlviewex"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
...
public static RemoteObject _vis_visible = RemoteObject.createImmutable(0);
public static RemoteObject _vis_invisible = RemoteObject.createImmutable(0);
public static RemoteObject _vis_gone = RemoteObject.createImmutable(0);
