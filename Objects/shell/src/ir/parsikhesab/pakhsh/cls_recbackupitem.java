...
public class cls_recbackupitem {
    public static RemoteObject myClass;
	public cls_recbackupitem() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recbackupitem.class);
...
public static RemoteObject _lblrow = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
