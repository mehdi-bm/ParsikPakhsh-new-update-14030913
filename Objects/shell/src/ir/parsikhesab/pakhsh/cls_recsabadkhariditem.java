...
public class cls_recsabadkhariditem {
    public static RemoteObject myClass;
	public cls_recsabadkhariditem() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recsabadkhariditem.class);
...
public static RemoteObject _lbl_price = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbl_title = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _img_kala = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
...
public static RemoteObject _lblremove = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _txtcomment = RemoteObject.declareNull("anywheresoftware.b4a.objects.EditTextWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"BtnDownEshan",_ref.getField(false, "_btndowneshan"),"BtnDownJoz",_ref.getField(false, "_btndownjoz"),"BtnDownKol",_ref.getField(false, "_btndownkol"),"BtnUpEshan",_ref.getField(false, "_btnupeshan"),"BtnUpJoz",_ref.getField(false, "_btnupjoz"),"BtnUpKol",_ref.getField(false, "_btnupkol"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"ImageOff",_ref.getField(false, "_imageoff"),"Img_Kala",_ref.getField(false, "_img_kala"),"item",_ref.getField(false, "_item"),"lbl_Price",_ref.getField(false, "_lbl_price"),"lbl_title",_ref.getField(false, "_lbl_title"),"LblBuyPrice",_ref.getField(false, "_lblbuyprice"),"LblC_Kala",_ref.getField(false, "_lblc_kala"),"lblDarsadTakhfif",_ref.getField(false, "_lbldarsadtakhfif"),"LblFeeBadAzTakhfid",_ref.getField(false, "_lblfeebadaztakhfid"),"LblFeeYekKarton",_ref.getField(false, "_lblfeeyekkarton"),"LblGift",_ref.getField(false, "_lblgift"),"LblMablaghTakhfif",_ref.getField(false, "_lblmablaghtakhfif"),"LblMojoodiJoz",_ref.getField(false, "_lblmojoodijoz"),"LblMojoodiKol",_ref.getField(false, "_lblmojoodikol"),"lblRemove",_ref.getField(false, "_lblremove"),"lblSumMablaghKala",_ref.getField(false, "_lblsummablaghkala"),"LblTedadEshan",_ref.getField(false, "_lbltedadeshan"),"lblTedadjoz",_ref.getField(false, "_lbltedadjoz"),"LblTedadKarton",_ref.getField(false, "_lbltedadkarton"),"lblTedadKol",_ref.getField(false, "_lbltedadkol"),"LblTozihat",_ref.getField(false, "_lbltozihat"),"lblVahedJoz",_ref.getField(false, "_lblvahedjoz"),"lblVahedKol",_ref.getField(false, "_lblvahedkol"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"maxkolRond",_ref.getField(false, "_maxkolrond"),"p",_ref.getField(false, "_p"),"Panel2",_ref.getField(false, "_panel2"),"Panel3",_ref.getField(false, "_panel3"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_BK",_ref.getField(false, "_pnl_bk"),"pnlEshan",_ref.getField(false, "_pnleshan"),"pnlJoz",_ref.getField(false, "_pnljoz"),"pnlKol",_ref.getField(false, "_pnlkol"),"Priority",_ref.getField(false, "_priority"),"txtComment",_ref.getField(false, "_txtcomment")};
}
}