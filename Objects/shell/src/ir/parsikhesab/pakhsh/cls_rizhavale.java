...
public class cls_rizhavale {
    public static RemoteObject myClass;
	public cls_rizhavale() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rizhavale.class);

public static RemoteObject __c = RemoteObject.declareNull("anywheresoftware.b4a.keywords.Common");
public static RemoteObject _p = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterizhavale");
...
public static RemoteObject _lbl_tell = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbladdress = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btnshowmap = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"BtnShowMap",_ref.getField(false, "_btnshowmap"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"Item",_ref.getField(false, "_item"),"Lbl_Tell",_ref.getField(false, "_lbl_tell"),"lblAddress",_ref.getField(false, "_lbladdress"),"LblC_Ashkhas",_ref.getField(false, "_lblc_ashkhas"),"lblCheck",_ref.getField(false, "_lblcheck"),"LblDate",_ref.getField(false, "_lbldate"),"LblN_Ashkhas",_ref.getField(false, "_lbln_ashkhas"),"LblShomareFaktor",_ref.getField(false, "_lblshomarefaktor"),"LblTotalFaktor",_ref.getField(false, "_lbltotalfaktor"),"lblUnCheck",_ref.getField(false, "_lbluncheck"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority"),"shomareHavale",_ref.getField(false, "_shomarehavale")};
}
}