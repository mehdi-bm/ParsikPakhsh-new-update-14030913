...
public class cls_faktor3_havale_type1_subs_0 {


public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 //BA.debugLineNum = 2;BA.debugLine="Sub Class_Globals";
 //BA.debugLineNum = 3;BA.debugLine="Private p As Panel";
cls_faktor3_havale_type1._p = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_p",cls_faktor3_havale_type1._p);
 //BA.debugLineNum = 4;BA.debugLine="Private pnl_bk As Panel";
cls_faktor3_havale_type1._pnl_bk = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");__ref.setField("_pnl_bk",cls_faktor3_havale_type1._pnl_bk);
 //BA.debugLineNum = 6;BA.debugLine="Private imgSign As ImageView";
cls_faktor3_havale_type1._imgsign = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");__ref.setField("_imgsign",cls_faktor3_havale_type1._imgsign);
 //BA.debugLineNum = 7;BA.debugLine="Private lblTozihat As Label";
cls_faktor3_havale_type1._lbltozihat = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lbltozihat",cls_faktor3_havale_type1._lbltozihat);
 //BA.debugLineNum = 8;BA.debugLine="Private lblSignS As Label";
cls_faktor3_havale_type1._lblsigns = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblsigns",cls_faktor3_havale_type1._lblsigns);
 //BA.debugLineNum = 10;BA.debugLine="Private LblGHabelePardakht As Label";
cls_faktor3_havale_type1._lblghabelepardakht = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblghabelepardakht",cls_faktor3_havale_type1._lblghabelepardakht);
 //BA.debugLineNum = 11;BA.debugLine="Private LblMablaghKhales As Label";
cls_faktor3_havale_type1._lblmablaghkhales = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblmablaghkhales",cls_faktor3_havale_type1._lblmablaghkhales);
 //BA.debugLineNum = 13;BA.debugLine="Private lblMandeTasfieNashode As Label";
cls_faktor3_havale_type1._lblmandetasfienashode = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblmandetasfienashode",cls_faktor3_havale_type1._lblmandetasfienashode);
 //BA.debugLineNum = 14;BA.debugLine="Private LblTakhfifKala As Label";
cls_faktor3_havale_type1._lbltakhfifkala = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lbltakhfifkala",cls_faktor3_havale_type1._lbltakhfifkala);
 //BA.debugLineNum = 15;BA.debugLine="Private LblTotalFaktor As Label";
cls_faktor3_havale_type1._lbltotalfaktor = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lbltotalfaktor",cls_faktor3_havale_type1._lbltotalfaktor);
 //BA.debugLineNum = 17;BA.debugLine="Private lblMablagheKolDaryafti As Label";
cls_faktor3_havale_type1._lblmablaghekoldaryafti = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblmablaghekoldaryafti",cls_faktor3_havale_type1._lblmablaghekoldaryafti);
 //BA.debugLineNum = 18;BA.debugLine="Private LblMablaghTakhfifDaryafti As Label";
cls_faktor3_havale_type1._lblmablaghtakhfifdaryafti = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");__ref.setField("_lblmablaghtakhfifdaryafti",cls_faktor3_havale_type1._lblmablaghtakhfifdaryafti);
 //BA.debugLineNum = 19;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _getheight(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("getHeight (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,65);
if (RapidSub.canDelegate("getheight")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","getheight", __ref);}
...
try {
		Debug.PushSubsStack("getLeft (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,71);
if (RapidSub.canDelegate("getleft")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","getleft", __ref);}
...
try {
		Debug.PushSubsStack("getPanel (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,57);
if (RapidSub.canDelegate("getpanel")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","getpanel", __ref);}
...
try {
		Debug.PushSubsStack("getTop (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,68);
if (RapidSub.canDelegate("gettop")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","gettop", __ref);}
...
try {
		Debug.PushSubsStack("getWidth (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,62);
if (RapidSub.canDelegate("getwidth")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","getwidth", __ref);}
...
try {
		Debug.PushSubsStack("Initialize (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,22);
if (RapidSub.canDelegate("initialize")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","initialize", __ref, _ba, _ghabelepardakht, _mablaghkhales, _mablaghtakhfifdaryafti, _mandetasfienashode, _takhfifkala, _mablaghekoldaryafti, _totalfaktor, _tozihat, _signaturebitmapstring);}
...
__ref.getField(false,"_p" /*RemoteObject*/ ).runVoidMethod ("SetLayout",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(cls_faktor3_havale_type1.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),__ref.getField(false, "ba"))),(Object)(cls_faktor3_havale_type1.__c.runMethod(true,"PerYToCurrent",(Object)(BA.numberCast(float.class, 100)),__ref.getField(false, "ba"))));
 BA.debugLineNum = 25;BA.debugLine="p.LoadLayout(\"l_faktor3_havale_Type1\")";
Debug.ShouldStop(16777216);
__ref.getField(false,"_p" /*RemoteObject*/ ).runMethodAndSync(false,"LoadLayout",(Object)(RemoteObject.createImmutable("l_faktor3_havale_Type1")),__ref.getField(false, "ba"));
...
Debug.ShouldStop(256);
cls_faktor3_havale_type1.__c.runVoidMethod ("LogImpl","591095059",RemoteObject.concat(RemoteObject.createImmutable("FldSignatureBitmapString: "),_signaturebitmapstring),0);
 BA.debugLineNum = 42;BA.debugLine="Log(SignatureBitmapString)";
Debug.ShouldStop(512);
cls_faktor3_havale_type1.__c.runVoidMethod ("LogImpl","591095060",_signaturebitmapstring,0);
 BA.debugLineNum = 43;BA.debugLine="Log(SignatureBitmapString.Length)";
Debug.ShouldStop(1024);
cls_faktor3_havale_type1.__c.runVoidMethod ("LogImpl","591095061",BA.NumberToString(_signaturebitmapstring.runMethod(true,"length")),0);
 BA.debugLineNum = 45;BA.debugLine="Dim str2 As String=MCode.Decrypted(SignatureBitm";
Debug.ShouldStop(4096);
_str2 = cls_faktor3_havale_type1._mcode.runMethod(true,"_decrypted" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_signaturebitmapstring));Debug.locals.put("str2", _str2);Debug.locals.put("str2", _str2);
...
__ref.getField(false,"_imgsign" /*RemoteObject*/ ).runMethod(false,"setBitmap",(__ref.runClassMethod (ir.parsikhesab.pakhsh.cls_faktor3_havale_type1.class, "_readblob" /*RemoteObject*/ ,(Object)(_str2.runMethod(true,"trim"))).getObject()));
 };
...
__ref.getField(false,"_imgsign" /*RemoteObject*/ ).runMethod(true,"setVisible",cls_faktor3_havale_type1.__c.getField(true,"True"));
 BA.debugLineNum = 53;BA.debugLine="Log(\"error emza....\")";
Debug.ShouldStop(1048576);
cls_faktor3_havale_type1.__c.runVoidMethod ("LogImpl","591095071",RemoteObject.createImmutable("error emza...."),0);
 };
...
try {
		Debug.PushSubsStack("ReadBlob (cls_faktor3_havale_type1) ","cls_faktor3_havale_type1",64,__ref.getField(false, "ba"),__ref,75);
if (RapidSub.canDelegate("readblob")) { return __ref.runUserSub(false, "cls_faktor3_havale_type1","readblob", __ref, _emza);}
...
Debug.ShouldStop(8192);
_buffer = cls_faktor3_havale_type1._mcode._su /*RemoteObject*/ .runMethod(false,"DecodeBase64",(Object)(_emza));Debug.locals.put("Buffer", _buffer);
