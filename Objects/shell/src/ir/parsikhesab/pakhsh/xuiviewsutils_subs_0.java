...
try {
		Debug.PushSubsStack("AddStubToCLVIfNeeded (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,34);
if (RapidSub.canDelegate("addstubtoclvifneeded")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","addstubtoclvifneeded", _ba, _customlistview1, _color);}
...
try {
		Debug.PushSubsStack("CreateB4XImageView (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,85);
if (RapidSub.canDelegate("createb4ximageview")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createb4ximageview", _ba);}
RemoteObject _iv = RemoteObject.declareNull("ir.parsikhesab.pakhsh.b4ximageview");
...
Debug.JustUpdateDeviceLine();
_iv = RemoteObject.createNew ("ir.parsikhesab.pakhsh.b4ximageview");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 87;BA.debugLine="iv.Initialize(Null, \"\")";
Debug.JustUpdateDeviceLine();
_iv.runClassMethod (ir.parsikhesab.pakhsh.b4ximageview.class, "_initialize" /*RemoteObject*/ ,_ba,(Object)(xuiviewsutils.mostCurrent.__c.getField(false,"Null")),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("CreateLabel (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,78);
if (RapidSub.canDelegate("createlabel")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","createlabel", _ba);}
...
try {
		Debug.PushSubsStack("Initialize (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,10);
if (RapidSub.canDelegate("initialize")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","initialize", _ba);}
;
...
try {
		Debug.PushSubsStack("PerformHapticFeedback (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,21);
if (RapidSub.canDelegate("performhapticfeedback")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","performhapticfeedback", _ba, _view);}
...
try {
		Debug.PushSubsStack("SetAlpha (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,95);
if (RapidSub.canDelegate("setalpha")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setalpha", _ba, _view, _level);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
...
try {
		Debug.PushSubsStack("SetBitmapAndFill (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,65);
if (RapidSub.canDelegate("setbitmapandfill")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","setbitmapandfill", _ba, _imageview, _bmp);}
...
try {
		Debug.PushSubsStack("SetTextOrCSBuilderToLabel (xuiviewsutils) ","xuiviewsutils",139,_ba,xuiviewsutils.mostCurrent,50);
if (RapidSub.canDelegate("settextorcsbuildertolabel")) { return ir.parsikhesab.pakhsh.xuiviewsutils.remoteMe.runUserSub(false, "xuiviewsutils","settextorcsbuildertolabel", _ba, _xlbl, _text);}
;
