...
public class cls_faktor3_havale_type1 {
    public static RemoteObject myClass;
	public cls_faktor3_havale_type1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_faktor3_havale_type1.class);
...
public static RemoteObject _imgsign = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _lbltozihat = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsigns = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblmandetasfienashode = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblmablaghtakhfifdaryafti = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"imgSign",_ref.getField(false, "_imgsign"),"LblGHabelePardakht",_ref.getField(false, "_lblghabelepardakht"),"lblMablagheKolDaryafti",_ref.getField(false, "_lblmablaghekoldaryafti"),"LblMablaghKhales",_ref.getField(false, "_lblmablaghkhales"),"LblMablaghTakhfifDaryafti",_ref.getField(false, "_lblmablaghtakhfifdaryafti"),"lblMandeTasfieNashode",_ref.getField(false, "_lblmandetasfienashode"),"lblSignS",_ref.getField(false, "_lblsigns"),"LblTakhfifKala",_ref.getField(false, "_lbltakhfifkala"),"LblTotalFaktor",_ref.getField(false, "_lbltotalfaktor"),"lblTozihat",_ref.getField(false, "_lbltozihat"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}