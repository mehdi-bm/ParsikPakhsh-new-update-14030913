...
public class cls_rec_rizfactorvisitor {
    public static RemoteObject myClass;
	public cls_rec_rizfactorvisitor() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_rizfactorvisitor.class);
...
public static RemoteObject _lblcodekala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblfeejoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblsharhkala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadcarton = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadjoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmablaghkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedaddarkarton = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
