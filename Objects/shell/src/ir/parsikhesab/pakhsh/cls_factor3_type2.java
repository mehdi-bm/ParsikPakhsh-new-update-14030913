...
public class cls_factor3_type2 {
    public static RemoteObject myClass;
	public cls_factor3_type2() {
	}
    public static PCBA staticBA = new PCBA(null, cls_factor3_type2.class);
...
public static RemoteObject _lblsumpardakht = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblsumkoltakhfif = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
