...
public class cls_rec_restorfileitem {
    public static RemoteObject myClass;
	public cls_rec_restorfileitem() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_restorfileitem.class);
...
public static RemoteObject _lblnamefile = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _item = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistbackupfile");
