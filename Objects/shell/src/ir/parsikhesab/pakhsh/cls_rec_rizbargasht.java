...
public class cls_rec_rizbargasht {
    public static RemoteObject myClass;
	public cls_rec_rizbargasht() {
	}
    public static PCBA staticBA = new PCBA(null, cls_rec_rizbargasht.class);
...
public static RemoteObject _itemfactor = RemoteObject.declareNull("ir.parsikhesab.pakhsh.mcode._adapterlistrizefaktor");
...
public static RemoteObject _lbltotalfactor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
