...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"lblTitle",_ref.getField(false, "_lbltitle"),"lblVer",_ref.getField(false, "_lblver"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnlLogo",_ref.getField(false, "_pnllogo"),"pnlTitle",_ref.getField(false, "_pnltitle"),"pnlVer",_ref.getField(false, "_pnlver"),"Priority",_ref.getField(false, "_priority"),"Root",_ref.getField(false, "_root"),"T_Gif",_ref.getField(false, "_t_gif"),"xui",_ref.getField(false, "_xui")};
}
}