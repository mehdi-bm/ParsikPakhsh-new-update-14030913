...
public class cls_recdefultkala {
    public static RemoteObject myClass;
	public cls_recdefultkala() {
	}
    public static PCBA staticBA = new PCBA(null, cls_recdefultkala.class);
...
public static RemoteObject _imageoff = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _lbl_title = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _imagecall = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _lblfee = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblfeebadaztakhfid = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblc_kala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _imagetozihat = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
public static RemoteObject _lblmojoodijoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmojoodikol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadkarton = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btnupjoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadjoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btndownjoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btndownkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btnupkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _btndowneshan = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btnupeshan = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltedadeshan = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblvahedjoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblvahedkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblbuyprice = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _btn_edit_price = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _maxkolrond = RemoteObject.createImmutable("");
public static RemoteObject _lblcounteshantion = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _btn_discount = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmablaghtakhfif = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblmablaghmasrafkonande = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblsummablaghkala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbldarsadtakhfif = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _pnljoz = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnlkol = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _pnleshan = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
public static RemoteObject _lblcodegroup = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblfeeyekkarton = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbldarsadarzeshafzodekala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblarzeshafzodekala = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _swdisablearzeshafzode = RemoteObject.declareNull("de.amberhome.objects.appcompat.ACSwitchCompatWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"base",_ref.getField(false, "_base"),"btn_discount",_ref.getField(false, "_btn_discount"),"btn_edit_Price",_ref.getField(false, "_btn_edit_price"),"BtnDownEshan",_ref.getField(false, "_btndowneshan"),"BtnDownJoz",_ref.getField(false, "_btndownjoz"),"BtnDownKol",_ref.getField(false, "_btndownkol"),"BtnUpEshan",_ref.getField(false, "_btnupeshan"),"BtnUpJoz",_ref.getField(false, "_btnupjoz"),"BtnUpKol",_ref.getField(false, "_btnupkol"),"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"ImageCall",_ref.getField(false, "_imagecall"),"ImageOff",_ref.getField(false, "_imageoff"),"ImageRow",_ref.getField(false, "_imagerow"),"ImageTozihat",_ref.getField(false, "_imagetozihat"),"Item",_ref.getField(false, "_item"),"Key",_ref.getField(false, "_key"),"lbl_title",_ref.getField(false, "_lbl_title"),"LblArzeshAfzodeKala",_ref.getField(false, "_lblarzeshafzodekala"),"LblBuyPrice",_ref.getField(false, "_lblbuyprice"),"LblC_Kala",_ref.getField(false, "_lblc_kala"),"LblCodeGroup",_ref.getField(false, "_lblcodegroup"),"LblCountEshantion",_ref.getField(false, "_lblcounteshantion"),"LblDarsadArzeshAfzodeKala",_ref.getField(false, "_lbldarsadarzeshafzodekala"),"lblDarsadTakhfif",_ref.getField(false, "_lbldarsadtakhfif"),"LblFee",_ref.getField(false, "_lblfee"),"LblFeeBadAzTakhfid",_ref.getField(false, "_lblfeebadaztakhfid"),"LblFeeYekKarton",_ref.getField(false, "_lblfeeyekkarton"),"LblGift",_ref.getField(false, "_lblgift"),"LblMablaghMasrafkonande",_ref.getField(false, "_lblmablaghmasrafkonande"),"LblMablaghTakhfif",_ref.getField(false, "_lblmablaghtakhfif"),"LblMojoodiJoz",_ref.getField(false, "_lblmojoodijoz"),"LblMojoodiKol",_ref.getField(false, "_lblmojoodikol"),"lblSumMablaghKala",_ref.getField(false, "_lblsummablaghkala"),"LblTedadEshan",_ref.getField(false, "_lbltedadeshan"),"LblTedadJoz",_ref.getField(false, "_lbltedadjoz"),"LblTedadKarton",_ref.getField(false, "_lbltedadkarton"),"LblTedadkol",_ref.getField(false, "_lbltedadkol"),"LblTozihat",_ref.getField(false, "_lbltozihat"),"lblVahedJoz",_ref.getField(false, "_lblvahedjoz"),"lblVahedKol",_ref.getField(false, "_lblvahedkol"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"maxkolRond",_ref.getField(false, "_maxkolrond"),"p",_ref.getField(false, "_p"),"Panel4",_ref.getField(false, "_panel4"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"pnlEshan",_ref.getField(false, "_pnleshan"),"pnlJoz",_ref.getField(false, "_pnljoz"),"pnlKol",_ref.getField(false, "_pnlkol"),"Priority",_ref.getField(false, "_priority"),"SwDisableArzeshAfzode",_ref.getField(false, "_swdisablearzeshafzode")};
}
}