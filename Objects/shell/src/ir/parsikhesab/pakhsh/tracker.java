...
public class tracker implements IRemote{
	public static tracker mostCurrent;
...
public boolean isSingleton() {
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("tracker"), "ir.parsikhesab.pakhsh.tracker");
	}
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
        ...
        remoteMe = RemoteObject.declareNull("ir.parsikhesab.pakhsh.tracker");
        anywheresoftware.b4a.keywords.Common.Density = (Float)args[3];
		pcBA = new PCBA(this, tracker.class);
...
public static RemoteObject _lastupdatetime = RemoteObject.createImmutable(0L);
