...
public class cls_faktor2_havale_type1 {
    public static RemoteObject myClass;
	public cls_faktor2_havale_type1() {
	}
    public static PCBA staticBA = new PCBA(null, cls_faktor2_havale_type1.class);
...
public static RemoteObject _lblfeetakhfifi = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblfeeyekkarton = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
