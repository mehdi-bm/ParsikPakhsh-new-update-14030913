...
public class cls_factor1_type2 {
    public static RemoteObject myClass;
	public cls_factor1_type2() {
	}
    public static PCBA staticBA = new PCBA(null, cls_factor1_type2.class);
...
public static RemoteObject _lbldatefactor = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lblnameco = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static RemoteObject _lblnamecompany = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbltellcompany = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _lbladdresscompany = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"DateUtils",_ref.getField(false, "_dateutils"),"FileProvider",_ref.getField(false, "_fileprovider"),"Granularity",_ref.getField(false, "_granularity"),"lblAddress",_ref.getField(false, "_lbladdress"),"lblAddressCompany",_ref.getField(false, "_lbladdresscompany"),"lblDateFactor",_ref.getField(false, "_lbldatefactor"),"lblNameCo",_ref.getField(false, "_lblnameco"),"lblNameCompany",_ref.getField(false, "_lblnamecompany"),"lblNameMoshtari",_ref.getField(false, "_lblnamemoshtari"),"lblShomareFactor",_ref.getField(false, "_lblshomarefactor"),"lblTell",_ref.getField(false, "_lbltell"),"lblTellCompany",_ref.getField(false, "_lbltellcompany"),"LocationF",_ref.getField(false, "_locationf"),"LocationRequest",_ref.getField(false, "_locationrequest"),"LocationResult",_ref.getField(false, "_locationresult"),"p",_ref.getField(false, "_p"),"PermissionsManager",_ref.getField(false, "_permissionsmanager"),"pnl_bk",_ref.getField(false, "_pnl_bk"),"Priority",_ref.getField(false, "_priority")};
}
}